...
export const ProfilePage = (props: ProfilePageProps) => {
  ...
  const EditField: React.FC<
    EditFieldProps & React.HTMLAttributes<HTMLDivElement>
  > = props => {
    ...
    <div className="bootstrap-4-backport blue-background profile-page">
      <Container>
        ...
        {isLoading ? (
          ...
          <Row>
            <Col sm={3}>{decoratedProfilePic}</Col>
            <Col sm={9}>
              <div className="grid-container">
                  ...
                  {!editing ? (
                    ...
                    <FormGroup style={{ display: 'inline-block' }}>
                      <EditField
                        ...
                        updateFn={setFirstName}
                      />
                      <EditField
                        label="Last name"
                        updatedValue={lastName}
                        updateFn={setLastName}
                      />
                    </FormGroup>
                  )}
                </div>
                ...
                <div className="containers">
                  {!editing ? (
                    userBundle?.userProfile?.summary
                  ) : (
                    <FormGroup>
                    ...
                    {!editing ? (
                      userBundle?.userProfile?.url && (
                        <a href={userBundle?.userProfile?.url}>
                          <img className="contact-icon" src={LinkIcon} />
                          {userBundle?.userProfile?.url}
                        </a>
                      )
                    ) : (
