  ...
  return (
    <div className="panel-wrapper-bg with-account-setting">
      <nav className="account-setting-panel nav-panel">
        ...
        <Button
          onClick={() => handleScroll(changePasswordRef)}
          variant="outlined"
        >
          Change Password
        </Button>
        <Button
          onClick={() => handleScroll(trustCredentialRef)}
          variant="outlined"
        >
          Trust & Credentials
        </Button>
      ...
      <div>
        ...
        >
          ...
          <p>
            This section lists the various ways we support verifying your trust
            and identity in order to permit access to our products. You may be
            asked to complete any of the following as part of requesting access
            within a system.
          </p>
          ...
          <div className="credential-partition">
            ...
            <p>
              There are times where human data can only be shared with certain
              restrictions. In order to upload data on any application, you must
              pass a quiz on the technical and ethical aspects of sharing data
              in our system.
            </p>
            <div className="item-completion">
              {isCertified ? (
          ...
          <div className="credential-partition">
            <h4>ORCID Profile</h4>
            <i>
              Linking your ORCID profile is useful for other researchers, and is
              required for profile validation.
            </i>
            <div className="item-completion">
              {orcid ? (
          ...
          <div className="credential-partition">
            ...
            <i>
              Users with a validated profile can access more features and data.
            </i>
            <p>
              Profile validation requires you to complete your profile, link an
              ORCID profile, sign and date the Sage pledge, and upload both the
              pledge and an identity attestation document, after which your
              application will be manually reviewed (which may take several
              days).
            </p>
            <div className="item-completion">
              {verified ? (
        ...
        >
          ...
          <p>
            ...
            with scoped access to your account. It is important that you treat
            personal access tokens with the same security as your password.
          </p>
          <Link sx={credentialButtonSX}>Manage Personal Access Tokens</Link>
          <Link
