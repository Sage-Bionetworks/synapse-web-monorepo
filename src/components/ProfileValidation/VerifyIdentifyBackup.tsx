        ...
        <>
            <div className="VerifyIdentify bootstrap-4-backport ValidationSteps">
                <Typography variant="headline1">
                    In order to validate your identify, we require:
                </Typography>
                <Typography variant="body1">
                    1. Accounts to have an ORCID. Please link your profile below.{' '}
                </Typography>
                ...
                <Typography variant="body1">
                    2. Submit recent identity attestation documentation. This document
                    must be current within the past month. Acceptable forms of
                    documentation, in English, are any one of the following:{' '}
                </Typography>
