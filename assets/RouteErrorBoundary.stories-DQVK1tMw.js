import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Fo as n,Gv as r,Lo as i,Px as a,QS as o,Ro as s,Ub as c,WS as l,Wo as u,ko as d}from"./iframe-Cc_1Im-O.js";var f,p,m,h,g,_,v,y,b,x,S,C=e((()=>{f=`_container_1jn5a_1`,p=`_errorBox_1jn5a_7`,m=`_icon_1jn5a_17`,h=`_errorTitle_1jn5a_23`,g=`_errorMessage_1jn5a_30`,_=`_detailsContainer_1jn5a_36`,v=`_detailsButton_1jn5a_40`,y=`_detailsBox_1jn5a_44`,b=`_detailsText_1jn5a_53`,x=`_reloadButton_1jn5a_61`,S={container:f,errorBox:p,icon:m,errorTitle:h,errorMessage:g,detailsContainer:_,detailsButton:v,detailsBox:y,detailsText:b,reloadButton:x}}));function w(e){let{icon:t}=e,n=u(),[r,i]=(0,T.useState)(!1),o,l;return s(n)?(o=`${n.status} ${n.statusText}`,l=n.data?.message):n instanceof Error?(o=n.message,l=n.stack):o=typeof n==`string`?n:`An unknown error occurred`,(0,E.jsx)(`div`,{className:S.container,children:(0,E.jsxs)(`div`,{className:S.errorBox,children:[t&&(0,E.jsx)(`img`,{src:t,alt:`Logo`,className:S.icon}),(0,E.jsx)(`h1`,{className:S.errorTitle,children:`Something went wrong`}),(0,E.jsx)(`p`,{className:S.errorMessage,children:o}),l&&(0,E.jsxs)(`div`,{className:S.detailsContainer,children:[(0,E.jsxs)(c,{variant:`text`,onClick:()=>i(!r),className:S.detailsButton,children:[r?`Hide`:`Show`,` details`]}),(0,E.jsx)(a,{in:r,children:(0,E.jsx)(`div`,{className:S.detailsBox,children:(0,E.jsx)(`pre`,{className:S.detailsText,children:l})})})]}),(0,E.jsx)(c,{variant:`contained`,onClick:()=>{window.location.reload()},className:S.reloadButton,children:`Reload Page`})]})})}var T,E,D=e((()=>{r(),T=t(o(),1),d(),C(),E=l();try{w.displayName=`RouteErrorBoundary`,w.__docgenInfo={description:`Error boundary component for React Router routes.
This component catches errors that occur during route loading or rendering,
including module initialization errors like circular dependencies.`,displayName:`RouteErrorBoundary`,filePath:`/home/runner/work/synapse-web-monorepo/synapse-web-monorepo/packages/synapse-react-client/src/components/error/RouteErrorBoundary.tsx`,methods:[],props:{icon:{defaultValue:null,declarations:[{fileName:`synapse-react-client/src/components/error/RouteErrorBoundary.tsx`,name:`TypeLiteral`}],description:``,name:`icon`,required:!1,tags:{},type:{name:`string`}}},tags:{}}}catch{}}));function O(e,t){return i([{path:`/`,element:(0,k.jsx)(`div`,{children:`This should not render`}),errorElement:(0,k.jsx)(w,{icon:t}),loader:()=>{throw e}}])}var k,A,j,M,N,P,F,I,L,R,z;e((()=>{d(),D(),k=l(),A={title:`Components/Error/RouteErrorBoundary`,component:w,parameters:{layout:`fullscreen`}},j={render:()=>(0,k.jsx)(n,{router:O(Error(`Something went wrong while loading the page`))})},M={render:()=>{let e=Error(`Failed to fetch data from the server`);return e.stack=`Error: Failed to fetch data from the server
