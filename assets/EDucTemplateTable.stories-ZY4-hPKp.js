import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{Gt as i,Hn as a,In as o,Kt as s,Rn as c}from"./synapse-client-Bqxhj3CF.js";import{nt as l,tt as u}from"./iframe-D1xKL6TJ.js";import{n as d,t as f}from"./EDucTemplateTable-De6sn4y0.js";var p,m,h,g,_;e((()=>{l(),a(),o(),r(),d(),p={title:`Governance/eDUC Templates Table`,component:f,parameters:{stack:`mock`,msw:{handlers:u(c)}}},m={name:`Templates table`},h={name:`Templates table — invalid validation result`,parameters:{msw:{handlers:[n.get(`${c}${s(`:templateId`)}`,()=>t.json({isValid:!1,reason:`Template is missing required signer tab.`},{status:200})),...u(c)]}}},g={name:`Templates table — empty`,parameters:{msw:{handlers:[n.post(`${c}${i}`,()=>t.json({results:[]},{status:200}))]}}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
