import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ab as n,Bo as r,Mv as i,No as a,Po as o,To as s,jS as c,jo as l,xx as u,zS as d}from"./iframe-DluvnujF.js";var f,p,m,h,g,_,v,y,b,x,S,C=e((()=>{f=`_container_1jn5a_1`,p=`_errorBox_1jn5a_7`,m=`_icon_1jn5a_17`,h=`_errorTitle_1jn5a_23`,g=`_errorMessage_1jn5a_30`,_=`_detailsContainer_1jn5a_36`,v=`_detailsButton_1jn5a_40`,y=`_detailsBox_1jn5a_44`,b=`_detailsText_1jn5a_53`,x=`_reloadButton_1jn5a_61`,S={container:f,errorBox:p,icon:m,errorTitle:h,errorMessage:g,detailsContainer:_,detailsButton:v,detailsBox:y,detailsText:b,reloadButton:x}}));function w(e){let{icon:t}=e,i=r(),[a,s]=(0,T.useState)(!1),c,l;return o(i)?(c=`${i.status} ${i.statusText}`,l=i.data?.message):i instanceof Error?(c=i.message,l=i.stack):c=typeof i==`string`?i:`An unknown error occurred`,(0,E.jsx)(`div`,{className:S.container,children:(0,E.jsxs)(`div`,{className:S.errorBox,children:[t&&(0,E.jsx)(`img`,{src:t,alt:`Logo`,className:S.icon}),(0,E.jsx)(`h1`,{className:S.errorTitle,children:`Something went wrong`}),(0,E.jsx)(`p`,{className:S.errorMessage,children:c}),l&&(0,E.jsxs)(`div`,{className:S.detailsContainer,children:[(0,E.jsxs)(n,{variant:`text`,onClick:()=>s(!a),className:S.detailsButton,children:[a?`Hide`:`Show`,` details`]}),(0,E.jsx)(u,{in:a,children:(0,E.jsx)(`div`,{className:S.detailsBox,children:(0,E.jsx)(`pre`,{className:S.detailsText,children:l})})})]}),(0,E.jsx)(n,{variant:`contained`,onClick:()=>{window.location.reload()},className:S.reloadButton,children:`Reload Page`})]})})}var T,E,D=e((()=>{i(),T=t(d(),1),s(),C(),E=c();try{w.displayName=`RouteErrorBoundary`,w.__docgenInfo={description:`Error boundary component for React Router routes.
This component catches errors that occur during route loading or rendering,
including module initialization errors like circular dependencies.`,displayName:`RouteErrorBoundary`,filePath:`/home/runner/work/synapse-web-monorepo/synapse-web-monorepo/packages/synapse-react-client/src/components/error/RouteErrorBoundary.tsx`,methods:[],props:{icon:{defaultValue:null,declarations:[{fileName:`synapse-react-client/src/components/error/RouteErrorBoundary.tsx`,name:`TypeLiteral`}],description:``,name:`icon`,required:!1,tags:{},type:{name:`string`}}},tags:{}}}catch{}}));function O(e,t){return a([{path:`/`,element:(0,k.jsx)(`div`,{children:`This should not render`}),errorElement:(0,k.jsx)(w,{icon:t}),loader:()=>{throw e}}])}var k,A,j,M,N,P,F,I,L,R,z;e((()=>{s(),D(),k=c(),A={title:`Components/Error/RouteErrorBoundary`,component:w,parameters:{layout:`fullscreen`}},j={render:()=>(0,k.jsx)(l,{router:O(Error(`Something went wrong while loading the page`))})},M={render:()=>{let e=Error(`Failed to fetch data from the server`);return e.stack=`Error: Failed to fetch data from the server
    ...
    at async RouteLoader (http://localhost:3000/node_modules/react-router/index.js:156:5)`,(0,k.jsx)(l,{router:O(e)})}},N={render:()=>{let e=ReferenceError(`Cannot access 'QueryWrapperPlotNav' before initialization`);return e.stack=`ReferenceError: Cannot access 'QueryWrapperPlotNav' before initialization
    ...
    at async __vite__moduleResolver (http://localhost:3000/vite/dist/client/env.mjs:165:7)`,(0,k.jsx)(l,{router:O(e,`https://raw.githubusercontent.com/Sage-Bionetworks/synapse-web-monorepo/main/apps/portals/adknowledgeportal/public/logo.svg`)})}},P={render:()=>(0,k.jsx)(l,{router:O({status:404,statusText:`Not Found`,data:{message:`The page you are looking for does not exist`}})})},F={render:()=>(0,k.jsx)(l,{router:O({status:500,statusText:`Internal Server Error`,data:{message:`An unexpected error occurred on the server`}})})},I={render:()=>(0,k.jsx)(l,{router:O(`An unexpected error occurred`)})},L={render:()=>(0,k.jsx)(l,{router:O({someUnknownError:`weird object`})})},R={render:()=>(0,k.jsx)(l,{router:O(Error(`Something went wrong while loading the page`),`https://raw.githubusercontent.com/Sage-Bionetworks/synapse-web-monorepo/main/apps/portals/adknowledgeportal/public/logo.svg`)})},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  render: () => {
