import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ai as n,Ao as r,Ic as i,Kb as a,Ni as o,P_ as s,Pc as c,QS as l,Ub as u,Vo as d,WS as f,Wv as p,_ as m,b as h,jo as g,ou as _,v,y,zu as b}from"./iframe-tFiJfl5m.js";function x(e){let{sql:t,href:n,prefixText:r=``,suffixText:s=``,...c}=e,l=i(t),f=d(),{data:p,isLoading:m}=o({concreteType:`org.sagebionetworks.repo.model.table.QueryBundleRequest`,query:{sql:t},entityId:l,partMask:2}),h=p?.queryCount,_=n?.startsWith(`http://`)||n?.startsWith(`https://`),v={};v=_?{href:n,target:`_blank`,rel:`noopener noreferrer`,component:`a`}:f?{to:n,component:g}:{href:n,component:`a`};let y=S.useMemo(()=>{let e=[];return r&&e.push(r),!m&&h!==void 0&&e.push(h.toLocaleString()),s&&e.push(s),e.join(` `)},[r,h,s,m]),x=(0,C.jsx)(a,{sx:{display:`flex`,alignItems:`center`,justifyContent:`center`,backgroundColor:`background.paper`,borderRadius:`50%`,width:24,height:24},children:(0,C.jsx)(b,{sx:{color:`primary.main`,fontSize:20}})});return(0,C.jsx)(u,{...c,...v,endIcon:x,loading:m,children:y})}var S,C,w=e((()=>{n(),s(),c(),p(),_(),S=t(l(),1),r(),C=f();try{x.displayName=`QueryCountButton`,x.__docgenInfo={description:`A button component that displays text with an inline count.
