import{o as e}from"./preload-helper-CsHsquCd.js";import{U as t,tn as n}from"./SynapseConstants-C6NyDJfS.js";import{Hn as r,Rn as i}from"./synapse-client-Bqxhj3CF.js";import{K as a,W as o,i as s,it as c,n as l,nt as u,r as d,rt as f,t as p}from"./iframe-Ct0lmlqY.js";import{m,p as h}from"./CardContainerLogic-BFLRm3CQ.js";var g,_,v,y,b,x;e((()=>{a(),s(),l(),f(),r(),n(),m(),{fn:g}=__STORYBOOK_MODULE_TEST__,_={title:`Explore/SearchQueryWrapperPlotNav`,component:h,parameters:{stack:`mock`,msw:{handlers:[o(i,{tableBundle:{columnModels:c.columnModels,maxRowsPerPage:25}}),...p(i),...d(i)]}},args:{searchIndexId:u,onQueryResultBundleChange:g()}},v={args:{name:`Search Results`,unitDescription:`result`,tableConfiguration:{columnLinks:[]},facetsToPlot:[`category`,`collections`,`topic`],availableFacets:[`category`,`collections`,`topic`,`dataTypes`,`isOpen`,`mature`,`registration`]}},y={args:{name:`Search Results`,cardConfiguration:{type:t,genericCardSchema:{type:`Standard`,title:`name`,subTitle:`acronym`,secondaryLabels:[`category`,`collections`,`topic`,`isOpen`]}},facetsToPlot:[`category`,`collections`,`topic`],availableFacets:[`category`,`collections`,`topic`,`dataTypes`,`isOpen`,`mature`,`registration`],defaultShowPlots:!0}},b={args:{name:`Search Results`,unitDescription:`result`,tableConfiguration:{},availableFacets:[`category`,`collections`,`topic`,`dataTypes`,`isOpen`,`mature`,`registration`],defaultShowPlots:!1,hideTopLevelControls:!1,hideQueryCount:!1}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    name: 'Search Results',
