...
standard cognitive and imaging assessments.`,g=[{key:`Status`,value:`Active`},{key:`Data Type`,value:`Genomics, Proteomics`},{key:`Access`,value:`Public`},{key:`Grant`,value:`NIH R01-AG123456`}],_=[{key:`Status`,value:`Active`},{key:`Data Type`,value:`Genomics, Proteomics`},{key:`Access`,value:`Public`},{key:`Grant`,value:`NIH R01-AG123456`},{key:`Principal Investigator`,value:`Dr. Jane Smith`},{key:`Institution`,value:`University of California, San Francisco`},{key:`Start Date`,value:`2021-03-01`},{key:`End Date`,value:`2026-02-28`},{key:`Disease Focus`,value:`Alzheimer's Disease`},{key:`Cohort Size`,value:`4,200 participants`},{key:`Biobank`,value:`Yes`},{key:`Species`,value:`Human`},{key:`Platform`,value:`Synapse`},{key:`DOI`,value:`10.7303/syn1234567`},{key:`Last Updated`,value:`2025-11-14`}],v={title:`Components/AdaptiveTwoColumnLayout`,component:c,parameters:{layout:`fullscreen`},argTypes:{leftContent:{control:!1},rightContent:{control:!1},onMeasure:{control:!1},stackRatioThreshold:{control:{type:`number`,min:.05,max:1.5,step:.05},description:`Stack when leftHeight ÷ rightHeight falls below this value. Default 0.45.`},gap:{control:`text`}}},y={name:`Side-by-side (long left / short right)`,render:e=>(0,p.jsx)(a,{sx:{padding:`40px 48px`,background:`#f8f9fa`},children:(0,p.jsx)(d,{stackRatioThreshold:e.stackRatioThreshold??.45,gap:e.gap??`40px`,leftContent:(0,p.jsx)(r,{variant:`body1`,sx:{lineHeight:1.65},children:m.trim()}),rightContent:(0,p.jsx)(l,{items:g})})}),args:{stackRatioThreshold:.45,gap:`40px`}},b={name:`Stacked (short left / tall right)`,render:e=>(0,p.jsx)(a,{sx:{padding:`40px 48px`,background:`#f8f9fa`},children:(0,p.jsx)(d,{stackRatioThreshold:e.stackRatioThreshold??.45,gap:e.gap??`40px`,leftContent:(0,p.jsx)(r,{variant:`body1`,sx:{lineHeight:1.65},children:h.trim()}),rightContent:(0,p.jsx)(l,{items:_})})}),args:{stackRatioThreshold:.45,gap:`40px`}},x={name:`HeaderCard-like (clamped description + properties)`,render:e=>(0,p.jsxs)(a,{sx:{background:`#253578`,color:`white`,padding:`40px 48px`},children:[(0,p.jsx)(r,{variant:`overline`,sx:{color:`rgba(255,255,255,0.65)`,letterSpacing:`0.1em`},children:`Study`}),(0,p.jsx)(r,{variant:`h5`,sx:{fontWeight:700,color:`white`,marginBottom:`24px`},children:`Longitudinal Analysis of Neurodegeneration in Aging Cohorts`}),(0,p.jsx)(d,{stackRatioThreshold:e.stackRatioThreshold??.45,gap:e.gap??`40px`,leftContent:(0,p.jsx)(a,{sx:{display:`-webkit-box`,WebkitLineClamp:4,WebkitBoxOrient:`vertical`,overflow:`hidden`,color:`rgba(255,255,255,0.9)`,lineHeight:1.65,fontSize:`0.9375rem`},children:m.trim()}),rightContent:(0,p.jsx)(l,{items:_.slice(0,8),color:`white`})})]}),args:{stackRatioThreshold:.45,gap:`40px`}},S={name:`Single column (no right content)`,render:e=>(0,p.jsx)(a,{sx:{padding:`40px 48px`,background:`#f8f9fa`},children:(0,p.jsx)(d,{stackRatioThreshold:e.stackRatioThreshold??.45,gap:e.gap??`40px`,leftContent:(0,p.jsx)(r,{variant:`body1`,sx:{lineHeight:1.65},children:m.trim()})})}),args:{stackRatioThreshold:.45}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
