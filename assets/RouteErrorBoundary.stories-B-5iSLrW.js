import{n as e}from"./chunk-jRWAZmH_.js";import{Lo as t,jo as n,qS as r,zo as i}from"./iframe-p8_tChL8.js";import{n as a,t as o}from"./RouteErrorBoundary-CPmsJkDc.js";function s(e,t){return i([{path:`/`,element:(0,c.jsx)(`div`,{children:`This should not render`}),errorElement:(0,c.jsx)(o,{icon:t}),loader:()=>{throw e}}])}var c,l,u,d,f,p,m,h,g,_,v;e((()=>{n(),a(),c=r(),l={title:`Components/Error/RouteErrorBoundary`,component:o,parameters:{layout:`fullscreen`}},u={render:()=>(0,c.jsx)(t,{router:s(Error(`Something went wrong while loading the page`))})},d={render:()=>{let e=Error(`Failed to fetch data from the server`);return e.stack=`Error: Failed to fetch data from the server
