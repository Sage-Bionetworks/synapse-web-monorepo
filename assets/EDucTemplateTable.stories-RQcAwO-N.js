import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{Fn as i,Gt as a,Ln as o,Vn as s,Wt as c}from"./synapse-client-CnbOkvM7.js";import{X as l,Z as u}from"./iframe-ByU5EOxB.js";import{n as d,t as f}from"./EDucTemplateTable-Com0dyQ1.js";var p,m,h,g,_;e((()=>{u(),s(),i(),r(),d(),p={title:`Governance/eDUC Templates Table`,component:f,parameters:{stack:`mock`,msw:{handlers:l(o)}}},m={name:`Templates table`},h={name:`Templates table — invalid validation result`,parameters:{msw:{handlers:[n.get(`${o}${a(`:templateId`)}`,()=>t.json({isValid:!1,reason:`Template is missing required signer tab.`},{status:200})),...l(o)]}}},g={name:`Templates table — empty`,parameters:{msw:{handlers:[n.post(`${o}${c}`,()=>t.json({results:[]},{status:200}))]}}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
