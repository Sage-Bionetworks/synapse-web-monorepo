import{n as e}from"./chunk-jRWAZmH_.js";import{ag as t,cg as n,cn as r,dn as i,m as a,on as o,p as s,pn as c,sn as l}from"./iframe-O5dcyH_2.js";import{n as u,t as d}from"./OpenInvitationsToUserCard-pBN9qYbl.js";var f,p,m,h,g,_;e((()=>{u(),a(),c(),r(),n(),f={title:`Features/Team/OpenInvitationsToUser`,component:d,parameters:{stack:`mock`},args:{cardProps:{sx:{p:4}}}},p={parameters:{msw:{handlers:{team:s(t,[{id:`invitation-1`,createdOn:new Date().toISOString(),createdBy:String(i),teamId:String(o),inviteeId:`999`,message:`Come join my cool team so we can submit to the challenge together!`},{id:`invitation-2`,createdOn:new Date().toISOString(),createdBy:String(i),teamId:String(l),inviteeId:`999`,message:`We would love to have you on our research team!`}])}}}},m={parameters:{msw:{handlers:{team:s(t,[])}}}},h={parameters:{msw:{handlers:{team:s(t,[{id:`invitation-1`,createdOn:new Date().toISOString(),createdBy:String(i),teamId:String(o),inviteeId:`999`,message:`Join our team!`}])}}}},g={parameters:{msw:{handlers:{team:s(t,[{id:`invitation-1`,createdOn:new Date().toISOString(),createdBy:String(i),teamId:String(o),inviteeId:`999`}])}}}},p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
      handlers: {
