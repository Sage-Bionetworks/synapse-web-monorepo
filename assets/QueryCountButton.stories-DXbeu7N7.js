import{o as e,u as t}from"./preload-helper-CsHsquCd.js";import{t as n}from"./react-bNwv3Ykw.js";import{t as r}from"./jsx-runtime-l3w3GfrB.js";import{fn as i,sn as a,t as o}from"./esm-BQdkvd-v.js";import{Zt as s}from"./SynapseConstants-BI9TI8Xa.js";import{in as c,t as l}from"./esm-BQyLErJE.js";import{Gt as u,Ht as d}from"./useLogin-BMcFf1u4.js";import{D as f,T as p}from"./SynapseContext-C9lS7oX9.js";import{m,n as h,t as g}from"./development-B31D2zYJ.js";import{_,b as v,v as y,y as b}from"./iframe-Dl8V2DMg.js";function x(e){let{sql:t,href:n,prefixText:r=``,suffixText:o=``,...s}=e,l=f(t),d=m(),{data:p,isLoading:g}=u({concreteType:`org.sagebionetworks.repo.model.table.QueryBundleRequest`,query:{sql:t},entityId:l,partMask:2}),_=p?.queryCount,v=n?.startsWith(`http://`)||n?.startsWith(`https://`),y={};y=v?{href:n,target:`_blank`,rel:`noopener noreferrer`,component:`a`}:d?{to:n,component:h}:{href:n,component:`a`};let b=S.useMemo(()=>{let e=[];return r&&e.push(r),!g&&_!==void 0&&e.push(_.toLocaleString()),o&&e.push(o),e.join(` `)},[r,_,o,g]),x=(0,C.jsx)(i,{sx:{display:`flex`,alignItems:`center`,justifyContent:`center`,backgroundColor:`background.paper`,borderRadius:`50%`,width:24,height:24},children:(0,C.jsx)(c,{sx:{color:`primary.main`,fontSize:20}})});return(0,C.jsx)(a,{...s,...y,endIcon:x,loading:g,children:b})}var S,C,w=e((()=>{d(),s(),p(),o(),l(),S=t(n(),1),g(),C=r();try{x.displayName=`QueryCountButton`,x.__docgenInfo={description:`A button component that displays text with an inline count.
