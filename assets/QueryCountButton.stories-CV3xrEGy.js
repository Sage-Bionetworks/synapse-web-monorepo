import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ao as n,Bo as r,Bu as i,F_ as a,Fc as o,Gv as s,Kb as c,Mi as l,Nc as u,QS as d,Ub as f,WS as p,_ as m,b as h,ki as g,ko as _,su as v,v as y,y as b}from"./iframe-BpfDyheV.js";function x(e){let{sql:t,href:a,prefixText:s=``,suffixText:u=``,...d}=e,p=o(t),m=r(),{data:h,isLoading:g}=l({concreteType:`org.sagebionetworks.repo.model.table.QueryBundleRequest`,query:{sql:t},entityId:p,partMask:2}),_=h?.queryCount,v=a?.startsWith(`http://`)||a?.startsWith(`https://`),y={};y=v?{href:a,target:`_blank`,rel:`noopener noreferrer`,component:`a`}:m?{to:a,component:n}:{href:a,component:`a`};let b=S.useMemo(()=>{let e=[];return s&&e.push(s),!g&&_!==void 0&&e.push(_.toLocaleString()),u&&e.push(u),e.join(` `)},[s,_,u,g]),x=(0,C.jsx)(c,{sx:{display:`flex`,alignItems:`center`,justifyContent:`center`,backgroundColor:`background.paper`,borderRadius:`50%`,width:24,height:24},children:(0,C.jsx)(i,{sx:{color:`primary.main`,fontSize:20}})});return(0,C.jsx)(f,{...d,...y,endIcon:x,loading:g,children:b})}var S,C,w=e((()=>{g(),a(),u(),s(),v(),S=t(d(),1),_(),C=p();try{x.displayName=`QueryCountButton`,x.__docgenInfo={description:`A button component that displays text with an inline count.
