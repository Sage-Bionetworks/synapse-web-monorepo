import{n as e}from"./chunk-zsgVPwQN.js";import{n as t,r as n,t as r}from"./core-DzrPRFGD.js";import{Et as i,ht as a,t as o}from"./dist-jiKX-16m.js";import{Tn as s,ht as c,xn as l,yn as u}from"./SynapseClient-BzG4sNth.js";import{r as d}from"./mock_user_profile-NKYbA1Kn.js";import{n as f,r as p}from"./mockFileEntity-CgV97cUL.js";import{a as m,c as h,h as g,i as _,l as v,m as y,u as b}from"./mockAccessRequirements-DHvPpred.js";import{a as x,i as S,n as C,r as w}from"./wikiHandlers-CHp4Lhcn.js";import{a as T,n as E,r as D,t as O}from"./accessRequirementHandlers-Doe_B2mn.js";import{n as k,r as A}from"./entityHandlers-prkFhF6D.js";import{n as j,t as M}from"./researchProjectHandlers-CDh81FEQ.js";import{r as N,t as P}from"./userProfileHandlers-C6s1Sw_t.js";import{r as F,t as I}from"./AccessRequirementList-7yTyZVnf.js";function L(e){return[n.get(`${l}/auth/v1/2fa`,()=>{let n={status:e?`ENABLED`:`DISABLED`};return t.json(n,{status:200})})]}var R,z,B,V,H,U,W,G,K,q;e((()=>{_(),S(),f(),T(),A(),j(),N(),w(),d(),u(),s(),o(),r(),F(),R={title:`Governance/Data Access Request Flow/AccessRequirementList`,component:I,parameters:{stack:`mock`},argTypes:{isAuthenticated:{control:{type:`boolean`}}},args:{isAuthenticated:!0}},z={args:{entityId:p.id,renderAsModal:!0},parameters:{msw:{handlers:[...k(l),...L(!1),...E(l),...O(l,void 0,[])]}}},B={parameters:{msw:{handlers:[...k(l),P(l,!0,!0),...L(!0),...E(l),...O(l),...D(l,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:x.id,submittedBy:x.submittedBy,modifiedOn:x.modifiedOn,state:a.APPROVED}},{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:g.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:m.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0}]),...C(l)]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},V=[...h,{...b,id:21},{...g,id:22},{...y,id:23},{...m,id:24}],H={parameters:{msw:{handlers:[...k(l),P(l,!0,!0),...L(!0),...E(l),...O(l,void 0,V),...D(l,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:x.id,submittedBy:x.submittedBy,modifiedOn:x.modifiedOn,state:a.APPROVED}},{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:g.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:m.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:`21`,concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`22`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`23`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`24`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...C(l),...M(l),n.post(`${l}${c}`,()=>{let e={requirementId:m.id,submitterId:`999`,accessorId:`999`,state:i.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},U={parameters:{msw:{handlers:[...k(l),P(l,!0,!1),...L(!0),...E(l),...O(l),...D(l,[{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...C(l),n.post(`${l}${c}`,()=>{let e={requirementId:y.id,submitterId:`999`,accessorId:`999`,state:i.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,renderAsModal:!0,isAuthenticated:!0}},W={parameters:{msw:{handlers:[...k(l),P(l,!1,!0),...L(!0),...E(l),...O(l),...D(l,[{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...C(l),n.post(`${l}${c}`,()=>{let e={requirementId:y.id,submitterId:`999`,accessorId:`999`,state:i.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,renderAsModal:!0,isAuthenticated:!0}},G={parameters:{msw:{handlers:[...k(l),P(l,!0,!0),...L(!0),...E(l),...O(l,void 0,[b]),...D(l,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1,currentSubmissionStatus:{submissionId:x.id,submittedBy:x.submittedBy,modifiedOn:x.modifiedOn,state:a.REJECTED,rejectedReason:`Thank you for requesting access, but you were rejected. Here's why:
 * You did not meet the requirements.
 * Another reason: you did not meet the requirements.
Feel free to apply again.`}}]),...C(l),...M(l)]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},K={args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0},parameters:{msw:{handlers:[...k(l),P(l,!0,!0),...L(!0),...E(l),...O(l,void 0,[v]),...D(l,[{accessRequirementId:v.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...C(l)]}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  args: {
