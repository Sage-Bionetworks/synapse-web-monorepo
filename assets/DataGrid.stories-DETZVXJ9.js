...
}`,...S.parameters?.docs?.source},description:{story:`Values that do not match the column's schema type, as written by server-side
CSV import. Numeric and date-time cells display the stored value rather than
appearing empty, so the user can see what made the row invalid.`,...S.parameters?.docs?.description}}},C=[`BasicGrid`,`ViewOnlyGrid`,`MinimalGrid`,`WithValidationStates`,`WithSchemaMismatchedValues`]}))();export{v as BasicGrid,b as MinimalGrid,y as ViewOnlyGrid,S as WithSchemaMismatchedValues,x as WithValidationStates,C as __namedExportsOrder,p as default};