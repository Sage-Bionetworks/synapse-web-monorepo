import{iC as o,b as a,j as e,P as n,v as m}from"./iframe-ClOjSJTq.js";import{g as c,a as d}from"./changePasswordHandlers-ChfhcHyc.js";import{C as p}from"./ChangePassword-C8YyXu4D.js";import"./index-Chi_LkuB.js";import"./useUserBundle-F9LYJoss.js";import"./useChangePasswordFormState-ZBstFWBd.js";const R={title:"Authentication/ChangePassword/WithCurrentPassword",component:p,parameters:{stack:"mock",withRouter:!0},decorators:[t=>e.jsxs(e.Fragment,{children:["This story uses mock server responses. You may need to refresh the page to reset the mock server responses.",e.jsx(n,{sx:{my:4,p:4,mx:"auto",width:"600px"},children:e.jsx(t,{})})]})]},r={parameters:{msw:{handlers:[c(a)]}}},s={parameters:{msw:{handlers:[d(a,m,"mock-2fa-token"),...o(a)]}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
