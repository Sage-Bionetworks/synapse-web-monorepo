import{n as e,o as t}from"./chunk-jRWAZmH_.js";import{Ab as n,Eo as r,Io as i,Mv as a,Nb as o,Nu as s,Oi as c,T_ as l,Ti as u,To as d,_ as f,g as p,h as m,jS as h,jc as g,kc as _,ru as v,v as y,zS as b}from"./iframe-Ds5PMKR1.js";function x(e){let{sql:t,href:a,prefixText:l=``,suffixText:u=``,...d}=e,f=g(t),p=i(),{data:m,isLoading:h}=c({concreteType:`org.sagebionetworks.repo.model.table.QueryBundleRequest`,query:{sql:t},entityId:f,partMask:2}),_=m?.queryCount,v=a?.startsWith(`http://`)||a?.startsWith(`https://`),y={};y=v?{href:a,target:`_blank`,rel:`noopener noreferrer`,component:`a`}:p?{to:a,component:r}:{href:a,component:`a`};let b=S.useMemo(()=>{let e=[];return l&&e.push(l),!h&&_!==void 0&&e.push(_.toLocaleString()),u&&e.push(u),e.join(` `)},[l,_,u,h]),x=(0,C.jsx)(o,{sx:{display:`flex`,alignItems:`center`,justifyContent:`center`,backgroundColor:`background.paper`,borderRadius:`50%`,width:24,height:24},children:(0,C.jsx)(s,{sx:{color:`primary.main`,fontSize:20}})});return(0,C.jsx)(n,{...d,...y,endIcon:x,loading:h,children:b})}var S,C,w=e((()=>{u(),l(),_(),a(),v(),S=t(b(),1),d(),C=h();try{x.displayName=`QueryCountButton`,x.__docgenInfo={description:`A button component that displays text with an inline count.
