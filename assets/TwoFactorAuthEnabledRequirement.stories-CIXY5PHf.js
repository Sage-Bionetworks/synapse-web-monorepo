import{n as d,b as l,H as i}from"./iframe-CrIG5yS4.js";import{T as h}from"./TwoFactorAuthEnabledRequirement-D5Y_nQeK.js";import"./index-r8ZA1smB.js";import"./RequirementItem-DKhuGz-n.js";import"./LockTwoTone-DA5SoG5S.js";const R={title:"Governance/Data Access Request Flow/Requirements/TwoFactorAuthEnabledRequirement",component:h,parameters:{stack:"mock"},argTypes:{isAuthenticated:{control:{type:"boolean"}}},args:{isAuthenticated:!0}};function m(u){return[d.get(`${l}/auth/v1/2fa`,()=>{const p={status:u?"ENABLED":"DISABLED"};return i.json(p,{status:200})})]}const e={parameters:{msw:{handlers:[m(!0)]}}},t={parameters:{msw:{handlers:[m(!1)]}}};var a,r,s;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  parameters: {
    msw: {
