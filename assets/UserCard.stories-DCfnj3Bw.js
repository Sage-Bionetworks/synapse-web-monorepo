import{cu as A,ct as p,cs as l,ci as u,cr as g,j as r,W as S,jX as R}from"./iframe-BXOaFC93.js";import{d as U}from"./useUserBundle-GtjAuzC1.js";import{c as d}from"./UserBadge-XxMl2-q6.js";import"./index-Chi_LkuB.js";import"./SkeletonTable-CeAdm2qt.js";import"./MenuItem-Dtwb3tI6.js";import"./Card-myTQBzog.js";import"./Chip-DABoi-5O.js";const k={title:"UI/UserCard",component:d,render:function(i){const{data:m}=U();let c=m?.ownerId;return c===R.toString()&&(c=void 0),r.jsxs(r.Fragment,{children:[r.jsx("p",{children:"If you are logged in, your avatar or card will appear. If you are not logged in, enter an ownerId (e.g. 273960) or alias (e.g. brucehoff) below."}),r.jsx(d,{ownerId:i.ownerId??c,...i})]})}},e={args:{size:A,avatarSize:"SMALL"}},a={args:{size:p}},s={args:{size:l}},o={decorators:[t=>r.jsx(S,{sx:{maxWidth:"450px"},children:r.jsx(t,{})})],args:{size:l,menuActions:[{field:"Action 1",callback:()=>{console.log("Action 1 clicked")}},{field:u},{field:"Action 2",callback:()=>{console.log("Action 2 clicked")}},{field:"Action 3",callback:()=>{console.log("Action 3 clicked")}}]}},n={args:{size:g}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    size: AVATAR,
    avatarSize: 'SMALL'
  }
