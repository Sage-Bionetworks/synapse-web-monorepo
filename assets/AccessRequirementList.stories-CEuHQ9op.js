import{n as e}from"./chunk-jRWAZmH_.js";import{C as t,Ct as n,Ft as r,I as i,It as a,L as o,L_ as s,Lh as c,Mt as l,Mv as u,Nt as d,Ot as f,St as p,Uv as m,Xt as h,Yt as g,Zt as _,a as v,bt as y,f as b,jt as x,kt as S,nn as C,o as w,og as T,pn as E,rg as D,tg as O,tn as k,u as A,vt as j,w as M,xt as N,yt as P}from"./iframe-Czj1srmR.js";import{r as F,t as I}from"./AccessRequirementList-vVfJkw1J.js";function L(e){return[_.get(`${D}/auth/v1/2fa`,()=>{let t={status:e?`ENABLED`:`DISABLED`};return h.json(t,{status:200})})]}var R,z,B,V,H,U,W,G,K,q;e((()=>{f(),p(),k(),N(),o(),M(),b(),w(),E(),O(),T(),s(),g(),F(),R={title:`Governance/Data Access Request Flow/AccessRequirementList`,component:I,parameters:{stack:`mock`},argTypes:{isAuthenticated:{control:{type:`boolean`}}},args:{isAuthenticated:!0}},z={args:{entityId:C.id,renderAsModal:!0},parameters:{msw:{handlers:[...i(D),...L(!1),...P(D),...j(D,void 0,[])]}}},B={parameters:{msw:{handlers:[...i(D),A(D,!0,!0),...L(!0),...P(D),...j(D),...y(D,[{accessRequirementId:d.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:n.id,submittedBy:n.submittedBy,modifiedOn:n.modifiedOn,state:u.APPROVED}},{accessRequirementId:r.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:a.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:S.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0}]),...v(D)]}},args:{entityId:C.id,isAuthenticated:!0,renderAsModal:!0}},V=[...x,{...d,id:21},{...a,id:22},{...r,id:23},{...S,id:24}],H={parameters:{msw:{handlers:[...i(D),A(D,!0,!0),...L(!0),...P(D),...j(D,void 0,V),...y(D,[{accessRequirementId:d.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:n.id,submittedBy:n.submittedBy,modifiedOn:n.modifiedOn,state:u.APPROVED}},{accessRequirementId:r.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:a.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:S.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:`21`,concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`22`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`23`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`24`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...v(D),...t(D),_.post(`${D}${c}`,()=>{let e={requirementId:S.id,submitterId:`999`,accessorId:`999`,state:m.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return h.json(e,{status:201})})]}},args:{entityId:C.id,isAuthenticated:!0,renderAsModal:!0}},U={parameters:{msw:{handlers:[...i(D),A(D,!0,!1),...L(!0),...P(D),...j(D),...y(D,[{accessRequirementId:r.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...v(D),_.post(`${D}${c}`,()=>{let e={requirementId:r.id,submitterId:`999`,accessorId:`999`,state:m.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return h.json(e,{status:201})})]}},args:{entityId:C.id,renderAsModal:!0,isAuthenticated:!0}},W={parameters:{msw:{handlers:[...i(D),A(D,!1,!0),...L(!0),...P(D),...j(D),...y(D,[{accessRequirementId:r.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...v(D),_.post(`${D}${c}`,()=>{let e={requirementId:r.id,submitterId:`999`,accessorId:`999`,state:m.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return h.json(e,{status:201})})]}},args:{entityId:C.id,renderAsModal:!0,isAuthenticated:!0}},G={parameters:{msw:{handlers:[...i(D),A(D,!0,!0),...L(!0),...P(D),...j(D,void 0,[d]),...y(D,[{accessRequirementId:d.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1,currentSubmissionStatus:{submissionId:n.id,submittedBy:n.submittedBy,modifiedOn:n.modifiedOn,state:u.REJECTED,rejectedReason:`Thank you for requesting access, but you were rejected. Here's why:
 * You did not meet the requirements.
 * Another reason: you did not meet the requirements.
Feel free to apply again.`}}]),...v(D),...t(D)]}},args:{entityId:C.id,isAuthenticated:!0,renderAsModal:!0}},K={args:{entityId:C.id,isAuthenticated:!0,renderAsModal:!0},parameters:{msw:{handlers:[...i(D),A(D,!0,!0),...L(!0),...P(D),...j(D,void 0,[l]),...y(D,[{accessRequirementId:l.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...v(D)]}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  args: {
