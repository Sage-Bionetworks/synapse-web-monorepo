import{cI as k,cH as z,cG as L,cw as D,cF as b,j as r,V as h,gW as j}from"./iframe-CrIG5yS4.js";import{d as w}from"./useUserBundle-WiP6qAW2.js";import{c as l}from"./UserBadge-BoI25jFW.js";import"./index-r8ZA1smB.js";import"./useSuspenseQuery-BDF5CGHD.js";import"./SkeletonTable-CZxqZr7Y.js";import"./MenuItem-DGqfgEGw.js";import"./Card-B7wB9TR3.js";import"./Chip-Cq9C0rq5.js";const N={title:"UI/UserCard",component:l,render:function(d){const{data:c}=w();let t=c==null?void 0:c.ownerId;return t===j.toString()&&(t=void 0),r.jsxs(r.Fragment,{children:[r.jsx("p",{children:"If you are logged in, your avatar or card will appear. If you are not logged in, enter an ownerId (e.g. 273960) or alias (e.g. brucehoff) below."}),r.jsx(l,{ownerId:d.ownerId??t,...d})]})}},e={args:{size:k,avatarSize:"SMALL"}},a={args:{size:z}},o={args:{size:L}},s={decorators:[i=>r.jsx(h,{sx:{maxWidth:"450px"},children:r.jsx(i,{})})],args:{size:L,menuActions:[{field:"Action 1",callback:()=>{console.log("Action 1 clicked")}},{field:D},{field:"Action 2",callback:()=>{console.log("Action 2 clicked")}},{field:"Action 3",callback:()=>{console.log("Action 3 clicked")}}]}},n={args:{size:b}};var m,A,p;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    size: AVATAR,
    avatarSize: 'SMALL'
  }
