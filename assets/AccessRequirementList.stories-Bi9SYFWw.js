import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{Cn as i,on as a,t as o}from"./dist-DIvCtTVI.js";import{Fn as s,Nn as c,yt as l,zn as u}from"./synapse-client-DT80sJpp.js";import{i as d}from"./mock_user_profile-DpGVXyMi.js";import{n as f,r as p}from"./mockFileEntity-CyWbbq0x.js";import{a as m,c as h,h as g,i as _,l as v,m as y,u as b}from"./mockAccessRequirements-D9S2eq8I.js";import{At as x,C as S,Mt as C,Nt as w,Pt as T,U as E,W as D,a as O,f as k,jt as A,kt as j,o as M,u as N,w as P}from"./iframe-BW3en15n.js";import{r as F,t as I}from"./AccessRequirementList-CPGiuqRw.js";function L(e){return[n.get(`${s}/auth/v1/2fa`,()=>{let n={status:e?`ENABLED`:`DISABLED`};return t.json(n,{status:200})})]}var R,z,B,V,H,U,W,G,K,q;e((()=>{_(),w(),f(),C(),D(),P(),k(),M(),d(),c(),u(),o(),r(),F(),R={title:`Governance/Data Access Request Flow/AccessRequirementList`,component:I,parameters:{stack:`mock`},argTypes:{isAuthenticated:{control:{type:`boolean`}}},args:{isAuthenticated:!0}},z={args:{entityId:p.id,renderAsModal:!0},parameters:{msw:{handlers:[...E(s),...L(!1),...x(s),...j(s,void 0,[])]}}},B={parameters:{msw:{handlers:[...E(s),N(s,!0,!0),...L(!0),...x(s),...j(s),...A(s,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:T.id,submittedBy:T.submittedBy,modifiedOn:T.modifiedOn,state:a.APPROVED}},{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:g.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:m.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0}]),...O(s)]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},V=[...h,{...b,id:21},{...g,id:22},{...y,id:23},{...m,id:24}],H={parameters:{msw:{handlers:[...E(s),N(s,!0,!0),...L(!0),...x(s),...j(s,void 0,V),...A(s,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:T.id,submittedBy:T.submittedBy,modifiedOn:T.modifiedOn,state:a.APPROVED}},{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:g.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:m.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:`21`,concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`22`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`23`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`24`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...O(s),...S(s),n.post(`${s}${l}`,()=>{let e={requirementId:m.id,submitterId:`999`,accessorId:`999`,state:i.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},U={parameters:{msw:{handlers:[...E(s),N(s,!0,!1),...L(!0),...x(s),...j(s),...A(s,[{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...O(s),n.post(`${s}${l}`,()=>{let e={requirementId:y.id,submitterId:`999`,accessorId:`999`,state:i.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,renderAsModal:!0,isAuthenticated:!0}},W={parameters:{msw:{handlers:[...E(s),N(s,!1,!0),...L(!0),...x(s),...j(s),...A(s,[{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...O(s),n.post(`${s}${l}`,()=>{let e={requirementId:y.id,submitterId:`999`,accessorId:`999`,state:i.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,renderAsModal:!0,isAuthenticated:!0}},G={parameters:{msw:{handlers:[...E(s),N(s,!0,!0),...L(!0),...x(s),...j(s,void 0,[b]),...A(s,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1,currentSubmissionStatus:{submissionId:T.id,submittedBy:T.submittedBy,modifiedOn:T.modifiedOn,state:a.REJECTED,rejectedReason:`Thank you for requesting access, but you were rejected. Here's why:
