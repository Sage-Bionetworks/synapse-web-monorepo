import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{Bt as i,Fn as a,Ln as o,Lt as s,Vn as c}from"./synapse-client-CZF9FYCe.js";import{i as l,u}from"./mockAccessRequirements-REdc47__.js";import{At as d,Mt as f,St as p,a as m,bt as h,d as g,f as _,o as v,xt as y,yt as b}from"./iframe-CeZURkYS.js";import{n as x,t as S}from"./EDucPreviewStep-DoeKhg7v.js";var C,w,T,E,D,O,k;e((()=>{l(),p(),f(),h(),_(),v(),a(),c(),r(),x(),C={...u,eDucTemplateId:`template-abc-123`},w=n.get(`${o}${s(y.id)}`,()=>t.json({fileHandleId:`mock-preview-file-handle-123`},{status:200})),T={title:`Governance/Data Access Request Flow/Managed Access Requirement/Step 2c - eDUC Preview`,component:S,parameters:{stack:`mock`,chromatic:{viewports:[600,1200]},msw:{handlers:[w,...g(o),...m(o),...d(o),...b(o)]}}},E={name:`eDUC preview step`,args:{managedACTAccessRequirement:C,previewSrcOverride:`https://www.rd.usda.gov/sites/default/files/pdf-sample_0.pdf`}},D={name:`eDUC preview — error state`,parameters:{msw:{handlers:[n.get(`${o}${s(y.id)}`,()=>t.json({reason:`Preview could not be generated at this time.`},{status:500})),...g(o),...m(o),...d(o),...b(o)]}},args:{managedACTAccessRequirement:C}},O={name:`eDUC preview — user at signature quota`,parameters:{msw:{handlers:[w,n.get(`${o}${i(y.id)}`,()=>t.json({quota:3,remaining:0},{status:200})),...g(o),...m(o),...d(o),...b(o)]}},args:{managedACTAccessRequirement:C,previewSrcOverride:`https://www.rd.usda.gov/sites/default/files/pdf-sample_0.pdf`}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
