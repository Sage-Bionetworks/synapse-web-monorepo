import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{Hn as i,In as a,Rn as o,Rt as s,Vt as c}from"./synapse-client-Bqxhj3CF.js";import{i as l,u}from"./mockAccessRequirements-Bh3YFkvB.js";import{Ct as d,Mt as f,Pt as p,St as m,a as h,d as g,f as _,o as v,wt as y,xt as b}from"./iframe-Ct0lmlqY.js";import{n as x,t as S}from"./EDucPreviewStep-CQQscCdQ.js";var C,w,T,E,D,O,k;e((()=>{l(),y(),p(),m(),_(),v(),a(),i(),r(),x(),C={...u,eDucTemplateId:`template-abc-123`},w=n.get(`${o}${s(d.id)}`,()=>t.json({fileHandleId:`mock-preview-file-handle-123`},{status:200})),T={title:`Governance/Data Access Request Flow/Managed Access Requirement/Step 2c - eDUC Preview`,component:S,parameters:{stack:`mock`,chromatic:{viewports:[600,1200]},msw:{handlers:[w,...g(o),...h(o),...f(o),...b(o)]}}},E={name:`eDUC preview step`,args:{managedACTAccessRequirement:C,previewSrcOverride:`https://www.rd.usda.gov/sites/default/files/pdf-sample_0.pdf`}},D={name:`eDUC preview — error state`,parameters:{msw:{handlers:[n.get(`${o}${s(d.id)}`,()=>t.json({reason:`Preview could not be generated at this time.`},{status:500})),...g(o),...h(o),...f(o),...b(o)]}},args:{managedACTAccessRequirement:C}},O={name:`eDUC preview — user at signature quota`,parameters:{msw:{handlers:[w,n.get(`${o}${c(d.id)}`,()=>t.json({quota:3,remaining:0},{status:200})),...g(o),...h(o),...f(o),...b(o)]}},args:{managedACTAccessRequirement:C,previewSrcOverride:`https://www.rd.usda.gov/sites/default/files/pdf-sample_0.pdf`}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
