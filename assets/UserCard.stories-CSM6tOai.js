import{cI as k,cH as z,cG as L,cw as D,cF as b,j as r,V as h,gW as j}from"./iframe-CXX3j3k4.js";import{d as w}from"./useUserBundle-DyX5qaSO.js";import{c as l}from"./UserBadge-BK9OLj7v.js";import"./index-r8ZA1smB.js";import"./useSuspenseQuery-BN00Uhyj.js";import"./SkeletonTable-Dy_jc2vl.js";import"./MenuItem-Bsjjr9Hj.js";import"./Card-8IXpSYq4.js";import"./Chip-BQx2btmN.js";const N={title:"UI/UserCard",component:l,render:function(d){const{data:c}=w();let t=c==null?void 0:c.ownerId;return t===j.toString()&&(t=void 0),r.jsxs(r.Fragment,{children:[r.jsx("p",{children:"If you are logged in, your avatar or card will appear. If you are not logged in, enter an ownerId (e.g. 273960) or alias (e.g. brucehoff) below."}),r.jsx(l,{ownerId:d.ownerId??t,...d})]})}},e={args:{size:k,avatarSize:"SMALL"}},a={args:{size:z}},o={args:{size:L}},s={decorators:[i=>r.jsx(h,{sx:{maxWidth:"450px"},children:r.jsx(i,{})})],args:{size:L,menuActions:[{field:"Action 1",callback:()=>{console.log("Action 1 clicked")}},{field:D},{field:"Action 2",callback:()=>{console.log("Action 2 clicked")}},{field:"Action 3",callback:()=>{console.log("Action 3 clicked")}}]}},n={args:{size:b}};var m,A,p;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    size: AVATAR,
    avatarSize: 'SMALL'
  }
