import{n as e}from"./chunk-jRWAZmH_.js";import{$ as t,Ev as n,F as r,J as i,L as a,L_ as o,Q as s,X as c,Y as l,Z as u,in as d,n as f,nn as p,og as m,pn as h,rg as g,rn as _,t as v,tn as y}from"./iframe-Czj1srmR.js";import{n as b,t as x}from"./EntityAclEditorModal-Dknl1bJc.js";var S,C,w,T,E,D,O,k,A,j;e((()=>{y(),i(),_(),b(),o(),h(),a(),m(),f(),S={title:`Synapse/Entity ACL Editor`,component:x,args:{open:!0}},C={args:{entityId:d.id},parameters:{stack:`mock`}},w={args:{entityId:d.id},parameters:{stack:`mock`,msw:{handlers:[r(g,{...d.bundle,benefactorAcl:{id:d.id,resourceAccess:[{principalId:999,accessType:[n.READ,n.DOWNLOAD,n.CREATE,n.UPDATE,n.DELETE,n.CHANGE_PERMISSIONS,n.CHANGE_SETTINGS,n.MODERATE]},{principalId:999,accessType:[n.READ]}]}}),...v(g)]}}},T={args:{entityId:l.id},parameters:{stack:`mock`}},E={args:{entityId:p.id},parameters:{stack:`mock`}},D={args:{entityId:c.id},parameters:{stack:`mock`}},O={args:{entityId:s.id},parameters:{stack:`mock`}},k={args:{entityId:u.id},parameters:{stack:`mock`}},A={args:{entityId:t.id},parameters:{stack:`mock`}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
