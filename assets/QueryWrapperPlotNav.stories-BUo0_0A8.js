import{n as e}from"./chunk-jRWAZmH_.js";import{Hg as t,N_ as n,Ng as r,O_ as i,P_ as a,T_ as o,Tc as s,jS as c,ln as l,pg as u,vf as d,vn as f,wc as p,wg as m,yf as h}from"./iframe-DutNvq_3.js";import{f as g,p as _}from"./CardContainerLogic-CFr2crW5.js";var v,y,b,x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B;e((()=>{d(),p(),o(),i(),l(),_(),v=c(),{fn:y}=__STORYBOOK_MODULE_TEST__,b={title:`Explore/QueryWrapperPlotNav`,component:g,decorators:[e=>(0,v.jsx)(`div`,{style:{paddingBottom:`50px`},children:(0,v.jsx)(e,{})})],args:{onQueryChange:y(),onQueryResultBundleChange:y()}},x={args:{name:`Data Catalog`,sql:`SELECT * FROM syn61609402 where includedInDataCatalog = 'true'`,defaultShowPlots:!1,defaultShowSearchBox:!0,hideCopyToClipboard:!0,hideSearchBarControl:!1,hideDownload:!0,cardConfiguration:{type:r,secondaryLabelLimit:4,genericCardSchema:{type:u,title:`name`,subTitle:`community`,description:`description`,secondaryLabels:[`contributors`,`individuals`,`id`,`link`]}}}},S=e=>{let t=e.queryContext?.getCurrentQueryRequest,n=e.queryContext?.executeQueryRequest;if(t===void 0||n===void 0){window.alert(`Query context functions not found, cannot apply additional filter`);return}let r=t();r.query.additionalFilters=[...r.query.additionalFilters||[],{concreteType:`org.sagebionetworks.repo.model.table.ColumnSingleValueQueryFilter`,columnName:`resourceType`,operator:a.EQUAL,values:[e.row.values[0]]}],n(r)},C={args:{name:`Tools`,sql:`SELECT * FROM syn51730943`,customPlots:[{query:`SELECT resourceType, count(resourceType) FROM syn51730943 GROUP BY resourceType `,type:`bar`,title:`Resource Type`,onCustomPlotClick:S}],limit:5,initialLimit:2,defaultShowPlots:!1,defaultShowSearchBox:!0,shouldDeepLink:!0,cardConfiguration:{type:r,titleLinkConfig:{isMarkdown:!1,baseURL:`Explore/Tools/DetailsPage`,URLColumnName:`resourceId`,matchColumnName:`resourceId`,overrideLinkURLColumnName:`biobankURL`},secondaryLabelLimit:4,genericCardSchema:{type:m,title:`resourceName`,subTitle:`resourceType`,description:`description`,secondaryLabels:[`investigatorName`,`institution`,`rrid`,`synonyms`,`cellLineCategory`,`cellLineDisease`,`modelofManifestation`,`backgroundStrain`,`backgroundSubstrain`,`animalModelDisease`,`animalModelOfManifestation`,`targetAntigen`,`reactiveSpecies`,`hostOrganism`,`specimenTissueType`,`specimenPreparationMethod`,`diseaseType`,`tumorType`,`specimenFormat`,`specimenType`,`dateModified`]}}}},w={args:{tableConfiguration:{showAccessColumn:!0,showDirectDownloadColumn:!0,columnLinks:[{matchColumnName:`study`,isMarkdown:!1,baseURL:`Explore/Studies/DetailsPage`,URLColumnName:`Study_Name`,wrapValueWithParens:!0},{matchColumnName:`name`,isMarkdown:!1,baseURL:`Explore/Files/DetailsPage`,URLColumnName:`FileId`,overrideValueWithRowID:!0,wrapValueWithParens:!1}]},searchConfiguration:{searchable:`study.dataType.assay.organ.tissue.species.diagnosis.sex.consortium.grant.modelSystemName.treatmentType.specimenID.individualID.individualIdSource.specimenIdSource.resourceType.dataSubtype.metadataType.assayTarget.analysisType.cellType.nucleicAcidSource.fileFormat.group.name.isModelSystem.isConsortiumAnalysis.isMultiSpecimen.metaboliteType.chromosome`.split(`.`)},shouldDeepLink:!0,visibleColumnCount:10,rgbIndex:1,name:`Data`,sqlOperator:a.EQUAL,sql:`SELECT * FROM syn11346063`,hideSqlEditorControl:!1}},T={sql:`SELECT * FROM syn11346063.28`,additionalFilters:[{concreteType:`org.sagebionetworks.repo.model.table.ColumnMultiValueFunctionQueryFilter`,columnName:`study`,function:n.HAS_LIKE,_function:n.HAS_LIKE,values:[`ADMC_ADNI_BakerLipidomics`]}]},E={args:{...w.args,shouldDeepLink:!1,initQueryJson:JSON.stringify(T),lockedColumn:{columnName:`study`,value:``}}},D={args:{sql:`SELECT * FROM syn11346063.69`,isRowSelectionVisible:!0,tableConfiguration:{showAccessColumn:!0,showDirectDownloadColumn:!0},unitDescription:`file`,name:`CAVATICA/Terra/Pluto Integration Demo`,hideSqlEditorControl:!1,shouldDeepLink:!1,enabledExternalAnalysisPlatforms:[`cavatica`,`terra`,`plutodev`]}},O=async e=>{let t=[];return e.request.query.sql=`select id from syn51186974`,(await h.getFullQueryTableResults(e.request)).queryResult?.queryResults.rows.map(e=>{e.values&&e.values[0]&&t.push(e.values[0])}),t},k=async e=>{let t=e.selectedRows&&e.selectedRows.length>0;f(`Custom action applied to ${t?e.selectedRows.length:`all`} rows (see js console for more information)`),console.log(`Rows selected:`),console.log(e.selectedRows);let n=e.queryMetadata?.columnModels?.findIndex(e=>e.name===`id`),r=t?e.selectedRows.map(e=>e.values[n]):await O(e),i={concreteType:`org.sagebionetworks.repo.model.table.ColumnSingleValueQueryFilter`,columnName:`id`,operator:a.IN,values:r};localStorage.setItem(s(`syn51186974-selectedfiles`),JSON.stringify([i])),console.log(`Local Storage value set, refresh table to see additionalFilter QueryFilter being utilized`),e.refresh()},A={args:{sql:`SELECT * FROM syn11346063.57`,isRowSelectionVisible:!0,tableConfiguration:{},name:`Row Selection Demo`,hideSqlEditorControl:!0,shouldDeepLink:!1,additionalFiltersSessionStorageKey:` syn11346063-selectedfiles`,customControls:[{buttonText:`Row Custom Command`,onClick:e=>{k(e)},buttonID:`RowSelectionCustomCommandButtonID`}]}},j={args:{sql:`SELECT * FROM syn51425243`,tableConfiguration:{showAccessColumn:!0,showDirectDownloadColumn:!0},name:`Table Has Access Requirement`,hideSqlEditorControl:!1,shouldDeepLink:!1}},M={args:{sql:`SELECT * FROM syn51489955`,tableConfiguration:{showAccessColumn:!1,showDirectDownloadColumn:!1},name:`No Table Download Access`,hideSqlEditorControl:!1,shouldDeepLink:!1,onViewSharingSettingsClicked:e=>{f(`Open the ${e} Sharing Settings dialog.  If undefined, send to the entity page.`,`info`,{primaryButtonConfig:{text:`Open Entity Page`,href:`https://www.synapse.org/Synapse:${e}`}})}}},N={args:{sql:`SELECT * FROM syn26302617`,tableConfiguration:{showAccessColumn:!0,showDirectDownloadColumn:!0},name:`Dataset Demo`,sqlOperator:a.EQUAL,hideSqlEditorControl:!1,shouldDeepLink:!1,enabledExternalAnalysisPlatforms:[`cavatica`,`terra`],helpConfiguration:[{columnName:`id`,helpText:`This represents the unique ID in Synapse`}]}},P={args:{sql:`SELECT * FROM syn33199585`,tableConfiguration:{showAccessColumn:!0,showDirectDownloadColumn:!0},name:`Dataset Collection Demo`,sqlOperator:a.EQUAL,hideSqlEditorControl:!1,shouldDeepLink:!1}},F={args:{sql:`SELECT * FROM syn13897207`,name:`People Demo`,sqlOperator:a.EQUAL,hideSqlEditorControl:!1,shouldDeepLink:!1,cardConfiguration:{type:t}}},I={args:{sql:`SELECT * FROM syn52115635`,tableConfiguration:{},name:`JSON Column Demo`,hideSqlEditorControl:!1,shouldDeepLink:!1}},L={args:{sql:`SELECT * FROM syn52737576`,tableConfiguration:{showAccessColumn:!0,showDirectDownloadColumn:!0},name:`MV with File Commands Demo`,sqlOperator:a.EQUAL,hideSqlEditorControl:!1,shouldDeepLink:!1,enabledExternalAnalysisPlatforms:[`cavatica`,`terra`],fileIdColumnName:`id`,fileNameColumnName:`name`,fileVersionColumnName:`currentVersion`}},R={parameters:{stack:`development`},args:{sql:`SELECT * FROM syn14227599`,tableConfiguration:{showAccessColumn:!0,showDirectDownloadColumn:!0},name:`Table with Click Wrap`,hideSqlEditorControl:!1,shouldDeepLink:!1,enabledExternalAnalysisPlatforms:[`cavatica`,`terra`],fileIdColumnName:`id`,fileNameColumnName:`name`,fileVersionColumnName:`currentVersion`}},z={args:{sql:`SELECT * FROM syn64926023`,tableConfiguration:{showAccessColumn:!0,showDirectDownloadColumn:!0},name:`Table with Range Types`,hideSqlEditorControl:!1,shouldDeepLink:!1,enabledExternalAnalysisPlatforms:[]}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    name: 'Data Catalog',
