import{cG as k,cF as z,cE as L,cq as D,cD as h,d2 as b,j as e,V as j,h0 as v}from"./iframe-Zu8RvZUL.js";import{c as l}from"./UserBadge-BWB7RQzA.js";import"./index-r8ZA1smB.js";import"./SkeletonTable-CPpj76Kj.js";import"./MenuItem-DJ5K5GB8.js";import"./Card-6xQl6A3R.js";import"./Chip-CUvuriGX.js";const B={title:"UI/UserCard",component:l,render:function(d){const{data:c}=b();let t=c==null?void 0:c.ownerId;return t===v.toString()&&(t=void 0),e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"If you are logged in, your avatar or card will appear. If you are not logged in, enter an ownerId (e.g. 273960) or alias (e.g. brucehoff) below."}),e.jsx(l,{ownerId:d.ownerId??t,...d})]})}},r={args:{size:k,avatarSize:"SMALL"}},a={args:{size:z}},s={args:{size:L}},o={decorators:[i=>e.jsx(j,{sx:{maxWidth:"450px"},children:e.jsx(i,{})})],args:{size:L,menuActions:[{field:"Action 1",callback:()=>{console.log("Action 1 clicked")}},{field:D},{field:"Action 2",callback:()=>{console.log("Action 2 clicked")}},{field:"Action 3",callback:()=>{console.log("Action 3 clicked")}}]}},n={args:{size:h}};var m,A,p;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    size: AVATAR,
    avatarSize: 'SMALL'
  }
