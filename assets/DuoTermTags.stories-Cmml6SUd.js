...
active-filter ("results filtered by") pills (full names, with a delete icon).`}}}},T={args:{terms:[`DUO:0000006`,`DUO:0000046`,`DUOplus7`]}},E={args:{terms:s.map(e=>e.code)}},D={args:{terms:[]},render:()=>(0,S.jsxs)(i,{sx:{width:320,p:2,border:e=>`1px solid ${e.palette.divider}`,borderRadius:1},children:[(0,S.jsx)(t,{variant:`smallText1`,sx:{fontWeight:600,mb:1,display:`block`},children:`Data Use Modifiers`}),s.map((e,t)=>(0,S.jsx)(v,{id:e.code,inputType:`checkbox`,isDropdown:!1,checked:!1,count:t*7%130,label:(0,S.jsx)(x,{code:e.code,truncate:!0}),onChange:()=>{},onHover:()=>{}},e.code))]})},O={args:{terms:[]},render:()=>(0,S.jsxs)(r,{gap:2,sx:{maxWidth:900},children:[(0,S.jsx)(g,{type:`DATASET`,title:`Whole-genome sequencing of NF1-associated tumors`,description:`A representative dataset carrying several data-use conditions, including a commercial-use restriction and an attribution requirement.`,icon:(0,S.jsx)(m,{type:`DATASET`,useTypeForIcon:!0}),labels:[{columnDisplayName:`Data Usage Restrictions`,value:(0,S.jsx)(u,{terms:[`DUO:0000006`,`DUO:0000046`,`DUOplus7`]})},{columnDisplayName:`Assay`,value:`Whole Genome Sequencing`},{columnDisplayName:`Species`,value:`Homo sapiens`}]}),(0,S.jsx)(g,{type:`DATASET`,title:`Disease-specific cohort with access conditions`,description:`Disease-specific research with ethics approval, geographic, and collaboration requirements.`,icon:(0,S.jsx)(m,{type:`DATASET`,useTypeForIcon:!0}),labels:[{columnDisplayName:`Data Usage Restrictions`,value:(0,S.jsx)(u,{terms:[`DUO:0000007`,`DUO:0000021`,`DUO:0000022`,`DUO:0000020`]})},{columnDisplayName:`Assay`,value:`RNA-seq`}]})]})},k={args:{terms:[]},render:()=>(0,S.jsx)(`div`,{className:`TotalQueryResults`,children:(0,S.jsxs)(`div`,{className:`TotalQueryResults__selections`,style:{display:`flex`,flexWrap:`wrap`},children:[[`DUO:0000006`,`DUO:0000042`,`DUO:0000046`].map(e=>{let t=C(`duo`,e);return(0,S.jsx)(b,{label:t.label,icon:t.icon,tooltipText:t.tooltipTitle,onRemoveFilter:()=>{}},e)}),(0,S.jsx)(b,{label:`2022`,tooltipText:`Year Processed: 2022`,onRemoveFilter:()=>{}},`year`)]})})},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...O.parameters?.docs?.source},description:{story:`On a dataset card, DUO terms appear as a "Data Usage Restrictions" row in the
metadata section, with full term names.`,...O.parameters?.docs?.description}}},k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
  args: {
    terms: []
  },
