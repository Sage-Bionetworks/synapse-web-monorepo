import{n as e}from"./chunk-jRWAZmH_.js";import{Fo as t,Lo as n,WS as r,ko as i}from"./iframe-B2RJAW0-.js";import{n as a,t as o}from"./RouteErrorBoundary-Bd5oyibF.js";function s(e,t){return n([{path:`/`,element:(0,c.jsx)(`div`,{children:`This should not render`}),errorElement:(0,c.jsx)(o,{icon:t}),loader:()=>{throw e}}])}var c,l,u,d,f,p,m,h,g,_,v;e((()=>{i(),a(),c=r(),l={title:`Components/Error/RouteErrorBoundary`,component:o,parameters:{layout:`fullscreen`}},u={render:()=>(0,c.jsx)(t,{router:s(Error(`Something went wrong while loading the page`))})},d={render:()=>{let e=Error(`Failed to fetch data from the server`);return e.stack=`Error: Failed to fetch data from the server
