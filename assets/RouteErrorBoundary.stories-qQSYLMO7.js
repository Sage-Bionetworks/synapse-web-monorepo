import{n as e}from"./chunk-jRWAZmH_.js";import{Ao as t,Io as n,Ro as r,WS as i}from"./iframe-BodYv8zs.js";import{n as a,t as o}from"./RouteErrorBoundary-D_ZwltR3.js";function s(e,t){return r([{path:`/`,element:(0,c.jsx)(`div`,{children:`This should not render`}),errorElement:(0,c.jsx)(o,{icon:t}),loader:()=>{throw e}}])}var c,l,u,d,f,p,m,h,g,_,v;e((()=>{t(),a(),c=i(),l={title:`Components/Error/RouteErrorBoundary`,component:o,parameters:{layout:`fullscreen`}},u={render:()=>(0,c.jsx)(n,{router:s(Error(`Something went wrong while loading the page`))})},d={render:()=>{let e=Error(`Failed to fetch data from the server`);return e.stack=`Error: Failed to fetch data from the server
