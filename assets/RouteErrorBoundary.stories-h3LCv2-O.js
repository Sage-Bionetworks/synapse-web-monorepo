import{n as e}from"./chunk-jRWAZmH_.js";import{Lo as t,jo as n,qS as r,zo as i}from"./iframe-BKPYB09_.js";import{n as a,t as o}from"./RouteErrorBoundary-DMEuB0Wn.js";function s(e,t){return i([{path:`/`,element:(0,c.jsx)(`div`,{children:`This should not render`}),errorElement:(0,c.jsx)(o,{icon:t}),loader:()=>{throw e}}])}var c,l,u,d,f,p,m,h,g,_,v;e((()=>{n(),a(),c=r(),l={title:`Components/Error/RouteErrorBoundary`,component:o,parameters:{layout:`fullscreen`}},u={render:()=>(0,c.jsx)(t,{router:s(Error(`Something went wrong while loading the page`))})},d={render:()=>{let e=Error(`Failed to fetch data from the server`);return e.stack=`Error: Failed to fetch data from the server
    ...
    at async RouteLoader (http://localhost:3000/node_modules/react-router/index.js:156:5)`,(0,c.jsx)(t,{router:s(e)})}},f={render:()=>{let e=ReferenceError(`Cannot access 'QueryWrapperPlotNav' before initialization`);return e.stack=`ReferenceError: Cannot access 'QueryWrapperPlotNav' before initialization
    ...
    at async __vite__moduleResolver (http://localhost:3000/vite/dist/client/env.mjs:165:7)`,(0,c.jsx)(t,{router:s(e,`https://raw.githubusercontent.com/Sage-Bionetworks/synapse-web-monorepo/main/apps/portals/adknowledgeportal/public/logo.svg`)})}},p={render:()=>(0,c.jsx)(t,{router:s({status:404,statusText:`Not Found`,data:{message:`The page you are looking for does not exist`}})})},m={render:()=>(0,c.jsx)(t,{router:s({status:500,statusText:`Internal Server Error`,data:{message:`An unexpected error occurred on the server`}})})},h={render:()=>(0,c.jsx)(t,{router:s(`An unexpected error occurred`)})},g={render:()=>(0,c.jsx)(t,{router:s({someUnknownError:`weird object`})})},_={render:()=>(0,c.jsx)(t,{router:s(Error(`Something went wrong while loading the page`),`https://raw.githubusercontent.com/Sage-Bionetworks/synapse-web-monorepo/main/apps/portals/adknowledgeportal/public/logo.svg`)})},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  render: () => {
