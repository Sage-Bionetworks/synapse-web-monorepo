import{n as e}from"./chunk-jRWAZmH_.js";import{Nx as t,S as n,WS as r,Wv as i,og as a,pn as o,rg as s,x as c}from"./iframe-CgptURe1.js";import{n as l,t as u}from"./ChangePassword-CcS1XFJV.js";import{n as d,r as f,t as p}from"./changePasswordHandlers-Bk4s04N2.js";var m,h,g,_,v;e((()=>{f(),n(),o(),a(),i(),l(),m=r(),h={title:`Authentication/ChangePassword/WithCurrentPassword`,component:u,parameters:{stack:`mock`,withRouter:!0},decorators:[e=>(0,m.jsxs)(m.Fragment,{children:[`This story uses mock server responses. You may need to refresh the page to reset the mock server responses.`,(0,m.jsx)(t,{sx:{my:4,p:4,mx:`auto`,width:`600px`},children:(0,m.jsx)(e,{})})]})]},g={parameters:{msw:{handlers:[d(s)]}}},_={parameters:{msw:{handlers:[p(s,999,`mock-2fa-token`),...c(s)]}}},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
