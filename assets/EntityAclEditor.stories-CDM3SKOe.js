import{n as e}from"./chunk-jRWAZmH_.js";import{$ as t,F as n,I_ as r,J as i,L as a,Q as o,Tv as s,X as c,Y as l,Z as u,ag as d,in as f,n as p,ng as m,nn as h,pn as g,rn as _,t as v,tn as y}from"./iframe-CFF1Lvns.js";import{n as b,t as x}from"./EntityAclEditorModal-DjJ7vjTb.js";var S,C,w,T,E,D,O,k,A,j;e((()=>{y(),i(),_(),b(),r(),g(),a(),d(),p(),S={title:`Synapse/Entity ACL Editor`,component:x,args:{open:!0}},C={args:{entityId:f.id},parameters:{stack:`mock`}},w={args:{entityId:f.id},parameters:{stack:`mock`,msw:{handlers:[n(m,{...f.bundle,benefactorAcl:{id:f.id,resourceAccess:[{principalId:999,accessType:[s.READ,s.DOWNLOAD,s.CREATE,s.UPDATE,s.DELETE,s.CHANGE_PERMISSIONS,s.CHANGE_SETTINGS,s.MODERATE]},{principalId:999,accessType:[s.READ]}]}}),...v(m)]}}},T={args:{entityId:l.id},parameters:{stack:`mock`}},E={args:{entityId:h.id},parameters:{stack:`mock`}},D={args:{entityId:c.id},parameters:{stack:`mock`}},O={args:{entityId:o.id},parameters:{stack:`mock`}},k={args:{entityId:u.id},parameters:{stack:`mock`}},A={args:{entityId:t.id},parameters:{stack:`mock`}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
