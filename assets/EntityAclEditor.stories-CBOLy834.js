import{o as e}from"./preload-helper-CsHsquCd.js";import{Zt as t,t as n}from"./dist-C7SMz8Oe.js";import{Hn as r,Rn as i}from"./synapse-client-Bqxhj3CF.js";import{i as a}from"./mock_user_profile-DpGVXyMi.js";import{n as o,t as s}from"./mockProject-CdPbXSRi.js";import{n as c,r as l}from"./mockFileEntity-BkB19yjo.js";import{K as u,W as d,at as f,ct as p,lt as m,n as h,ot as g,st as _,t as v,ut as y}from"./iframe-5Udvt434.js";import{n as b,t as x}from"./EntityAclEditorModal-X3WpMt_5.js";var S,C,w,T,E,D,O,k,A,j;e((()=>{c(),f(),s(),b(),n(),a(),u(),r(),h(),S={title:`Synapse/Entity ACL Editor`,component:x,args:{open:!0}},C={args:{entityId:o.id},parameters:{stack:`mock`}},w={args:{entityId:o.id},parameters:{stack:`mock`,msw:{handlers:[d(i,{...o.bundle,benefactorAcl:{id:o.id,resourceAccess:[{principalId:999,accessType:[t.READ,t.DOWNLOAD,t.CREATE,t.UPDATE,t.DELETE,t.CHANGE_PERMISSIONS,t.CHANGE_SETTINGS,t.MODERATE]},{principalId:999,accessType:[t.READ]}]}}),...v(i)]}}},T={args:{entityId:g.id},parameters:{stack:`mock`}},E={args:{entityId:l.id},parameters:{stack:`mock`}},D={args:{entityId:_.id},parameters:{stack:`mock`}},O={args:{entityId:m.id},parameters:{stack:`mock`}},k={args:{entityId:p.id},parameters:{stack:`mock`}},A={args:{entityId:y.id},parameters:{stack:`mock`}},C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  args: {
