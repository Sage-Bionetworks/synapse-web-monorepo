import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{sn as i,t as a,wn as o}from"./dist-C7SMz8Oe.js";import{Hn as s,In as c,Rn as l,xt as u}from"./synapse-client-Bqxhj3CF.js";import{i as d}from"./mock_user_profile-DpGVXyMi.js";import{n as f,r as p}from"./mockFileEntity-BkB19yjo.js";import{a as m,c as h,h as g,i as _,l as v,m as y,u as b}from"./mockAccessRequirements-Bh3YFkvB.js";import{Bt as x,E as S,It as C,Lt as w,Rt as T,T as E,Vt as D,X as O,Z as k,a as A,f as j,o as M,u as N,zt as P}from"./iframe-CHNVRxSI.js";import{i as F,t as I}from"./AccessRequirementList-DPT208Kg.js";function L(e){return[n.get(`${l}/auth/v1/2fa`,()=>{let n={status:e?`ENABLED`:`DISABLED`};return t.json(n,{status:200})})]}var R,z,B,V,H,U,W,G,K,q;e((()=>{_(),x(),f(),P(),k(),S(),j(),M(),d(),c(),s(),a(),r(),F(),R={title:`Governance/Data Access Request Flow/AccessRequirementList`,component:I,parameters:{stack:`mock`},argTypes:{isAuthenticated:{control:{type:`boolean`}}},args:{isAuthenticated:!0}},z={args:{entityId:p.id,renderAsModal:!0},parameters:{msw:{handlers:[...O(l),...L(!1),...w(l),...C(l,void 0,[])]}}},B={parameters:{msw:{handlers:[...O(l),N(l,!0,!0),...L(!0),...w(l),...C(l),...T(l,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:D.id,submittedBy:D.submittedBy,modifiedOn:D.modifiedOn,state:i.APPROVED}},{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:g.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:m.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0}]),...A(l)]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},V=[...h,{...b,id:21},{...g,id:22},{...y,id:23},{...m,id:24}],H={parameters:{msw:{handlers:[...O(l),N(l,!0,!0),...L(!0),...w(l),...C(l,void 0,V),...T(l,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!0,currentSubmissionStatus:{submissionId:D.id,submittedBy:D.submittedBy,modifiedOn:D.modifiedOn,state:i.APPROVED}},{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:g.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:m.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!0},{accessRequirementId:`21`,concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`22`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`23`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1},{accessRequirementId:`24`,concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...A(l),...E(l),n.post(`${l}${u}`,()=>{let e={requirementId:m.id,submitterId:`999`,accessorId:`999`,state:o.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},U={parameters:{msw:{handlers:[...O(l),N(l,!0,!1),...L(!0),...w(l),...C(l),...T(l,[{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...A(l),n.post(`${l}${u}`,()=>{let e={requirementId:y.id,submitterId:`999`,accessorId:`999`,state:o.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,renderAsModal:!0,isAuthenticated:!0}},W={parameters:{msw:{handlers:[...O(l),N(l,!1,!0),...L(!0),...w(l),...C(l),...T(l,[{accessRequirementId:y.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...A(l),n.post(`${l}${u}`,()=>{let e={requirementId:y.id,submitterId:`999`,accessorId:`999`,state:o.APPROVED,id:123,etag:`etag`,createdOn:new Date().toISOString(),modifiedOn:new Date().toISOString(),createdBy:`999`,modifiedBy:`999`};return t.json(e,{status:201})})]}},args:{entityId:p.id,renderAsModal:!0,isAuthenticated:!0}},G={parameters:{msw:{handlers:[...O(l),N(l,!0,!0),...L(!0),...w(l),...C(l,void 0,[b]),...T(l,[{accessRequirementId:b.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.ManagedACTAccessRequirementStatus`,isApproved:!1,currentSubmissionStatus:{submissionId:D.id,submittedBy:D.submittedBy,modifiedOn:D.modifiedOn,state:i.REJECTED,rejectedReason:`Thank you for requesting access, but you were rejected. Here's why:
 * You did not meet the requirements.
 * Another reason: you did not meet the requirements.
Feel free to apply again.`}}]),...A(l),...E(l)]}},args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0}},K={args:{entityId:p.id,isAuthenticated:!0,renderAsModal:!0},parameters:{msw:{handlers:[...O(l),N(l,!0,!0),...L(!0),...w(l),...C(l,void 0,[v]),...T(l,[{accessRequirementId:v.id.toString(),concreteType:`org.sagebionetworks.repo.model.dataaccess.BasicAccessRequirementStatus`,isApproved:!1}]),...A(l)]}}},z.parameters={...z.parameters,docs:{...z.parameters?.docs,source:{originalSource:`{
  args: {
