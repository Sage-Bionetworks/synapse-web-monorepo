import{a0 as k,gY as M,fh as B,eT as O,e0 as I,j as T,B as K,W as v,fm as D,a3 as t,d_ as s}from"./iframe-BoCRNbsR.js";import{N as A}from"./NavigateNext-CFzD_7u8.js";import"./index-Chi_LkuB.js";function Q(o){const{sql:q,href:a,prefixText:x="",suffixText:g="",...b}=o,_=k(q),L=M(),R={concreteType:"org.sagebionetworks.repo.model.table.QueryBundleRequest",query:{sql:q},entityId:_,partMask:O},{data:S,isLoading:y}=B(R),h=S?.queryCount,C=a?.startsWith("http://")||a?.startsWith("https://");let l={};C?l={href:a,target:"_blank",rel:"noopener noreferrer",component:"a"}:L?l={to:a,component:D}:l={href:a,component:"a"};const E=I.useMemo(()=>{const u=[];return x&&u.push(x),!y&&h!==void 0&&u.push(h.toLocaleString()),g&&u.push(g),u.join(" ")},[x,h,g,y]),w=T.jsx(v,{sx:{display:"flex",alignItems:"center",justifyContent:"center",backgroundColor:"background.paper",borderRadius:"50%",width:24,height:24},children:T.jsx(A,{sx:{color:"primary.main",fontSize:20}})});return T.jsx(K,{...b,...l,endIcon:w,loading:y,children:E})}try{Q.displayName="QueryCountButton",Q.__docgenInfo={description:`A button component that displays text with an inline count.
...
}`,...m.parameters?.docs?.source}}};const H=["Default","WithoutPrefixText","WithoutSuffixText","CountOnly","WithVariant","LargeCount"];export{c as CountOnly,i as Default,m as LargeCount,f as WithVariant,d as WithoutPrefixText,p as WithoutSuffixText,H as __namedExportsOrder,j as default};
