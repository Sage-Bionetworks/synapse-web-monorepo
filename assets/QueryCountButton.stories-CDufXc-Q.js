import{o as e,u as t}from"./preload-helper-CsHsquCd.js";import{t as n}from"./react-BXiJfEW5.js";import{t as r}from"./jsx-runtime-l3w3GfrB.js";import{ln as i,mn as a,t as o}from"./esm-CeuVXgHQ.js";import{Zt as s}from"./SynapseConstants-BI9TI8Xa.js";import{t as c,un as l}from"./esm-CLSP_jkQ.js";import{Kt as u,Yt as d}from"./useLogin-BDZfOWdc.js";import{D as f,T as p}from"./SynapseContext-CLDUvgym.js";import{m,n as h,t as g}from"./development-d0gZPMR5.js";import{_,b as v,v as y,y as b}from"./iframe-B2I_zgy1.js";function x(e){let{sql:t,href:n,prefixText:r=``,suffixText:o=``,...s}=e,c=f(t),u=m(),{data:p,isLoading:g}=d({concreteType:`org.sagebionetworks.repo.model.table.QueryBundleRequest`,query:{sql:t},entityId:c,partMask:2}),_=p?.queryCount,v=n?.startsWith(`http://`)||n?.startsWith(`https://`),y={};y=v?{href:n,target:`_blank`,rel:`noopener noreferrer`,component:`a`}:u?{to:n,component:h}:{href:n,component:`a`};let b=S.useMemo(()=>{let e=[];return r&&e.push(r),!g&&_!==void 0&&e.push(_.toLocaleString()),o&&e.push(o),e.join(` `)},[r,_,o,g]),x=(0,C.jsx)(a,{sx:{display:`flex`,alignItems:`center`,justifyContent:`center`,backgroundColor:`background.paper`,borderRadius:`50%`,width:24,height:24},children:(0,C.jsx)(l,{sx:{color:`primary.main`,fontSize:20}})});return(0,C.jsx)(i,{...s,...y,endIcon:x,loading:g,children:b})}var S,C,w=e((()=>{u(),s(),p(),o(),c(),S=t(n(),1),g(),C=r();try{x.displayName=`QueryCountButton`,x.__docgenInfo={description:`A button component that displays text with an inline count.
