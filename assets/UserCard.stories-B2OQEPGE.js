import{cG as k,cF as z,cE as L,cq as D,cD as b,d2 as h,j as e,V as j,g$ as v}from"./iframe-TYPaZ6LN.js";import{c as l}from"./UserBadge-AucszkFw.js";import"./index-r8ZA1smB.js";import"./SkeletonTable-CKGrlPmE.js";import"./MenuItem--XzA7FJc.js";import"./Card-CPwsCsQR.js";import"./Chip-CqTIrq2s.js";const B={title:"UI/UserCard",component:l,render:function(d){const{data:c}=h();let t=c==null?void 0:c.ownerId;return t===v.toString()&&(t=void 0),e.jsxs(e.Fragment,{children:[e.jsx("p",{children:"If you are logged in, your avatar or card will appear. If you are not logged in, enter an ownerId (e.g. 273960) or alias (e.g. brucehoff) below."}),e.jsx(l,{ownerId:d.ownerId??t,...d})]})}},r={args:{size:k,avatarSize:"SMALL"}},a={args:{size:z}},s={args:{size:L}},o={decorators:[i=>e.jsx(j,{sx:{maxWidth:"450px"},children:e.jsx(i,{})})],args:{size:L,menuActions:[{field:"Action 1",callback:()=>{console.log("Action 1 clicked")}},{field:D},{field:"Action 2",callback:()=>{console.log("Action 2 clicked")}},{field:"Action 3",callback:()=>{console.log("Action 3 clicked")}}]}},n={args:{size:b}};var m,A,p;r.parameters={...r.parameters,docs:{...(m=r.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    size: AVATAR,
    avatarSize: 'SMALL'
  }
