import{o as e,u as t}from"./preload-helper-CsHsquCd.js";import{t as n}from"./react-BXiJfEW5.js";import{t as r}from"./jsx-runtime-l3w3GfrB.js";import{Dn as i,Mn as a,t as o}from"./esm-CJoHTOXN.js";import{tn as s}from"./SynapseConstants-C6NyDJfS.js";import{Bn as c,t as l}from"./esm-LEXPPZke.js";import{on as u,rn as d}from"./useLogin-DO1ae3N8.js";import{E as f,O as p}from"./SynapseContext-5r-RDIl_.js";import{m,n as h,t as g}from"./development--dxNTjKx.js";import{_,b as v,v as y,y as b}from"./iframe-GZWw_2_x.js";function x(e){let{sql:t,href:n,prefixText:r=``,suffixText:o=``,...s}=e,l=p(t),d=m(),{data:f,isLoading:g}=u({concreteType:`org.sagebionetworks.repo.model.table.QueryBundleRequest`,query:{sql:t},entityId:l,partMask:2}),_=f?.queryCount,v=n?.startsWith(`http://`)||n?.startsWith(`https://`),y={};y=v?{href:n,target:`_blank`,rel:`noopener noreferrer`,component:`a`}:d?{to:n,component:h}:{href:n,component:`a`};let b=S.useMemo(()=>{let e=[];return r&&e.push(r),!g&&_!==void 0&&e.push(_.toLocaleString()),o&&e.push(o),e.join(` `)},[r,_,o,g]),x=(0,C.jsx)(a,{sx:{display:`flex`,alignItems:`center`,justifyContent:`center`,backgroundColor:`background.paper`,borderRadius:`50%`,width:24,height:24},children:(0,C.jsx)(c,{sx:{color:`primary.main`,fontSize:20}})});return(0,C.jsx)(i,{...s,...y,endIcon:x,loading:g,children:b})}var S,C,w=e((()=>{d(),s(),f(),o(),l(),S=t(n(),1),g(),C=r();try{x.displayName=`QueryCountButton`,x.__docgenInfo={description:`A button component that displays text with an inline count.
