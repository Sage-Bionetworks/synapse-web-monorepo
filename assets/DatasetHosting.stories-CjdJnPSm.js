import{o as e,u as t}from"./preload-helper-CsHsquCd.js";import{t as n}from"./react-BXiJfEW5.js";import{pn as r}from"./TextField-DshmLCH7.js";import{t as i}from"./jsx-runtime-l3w3GfrB.js";import{E as a,En as o,L as s,O as c,S as l,h as u,t as d,w as f}from"./esm-C-mwbP0X.js";import{tn as p,x as m}from"./SynapseConstants-C6NyDJfS.js";import{a as h,b as g,i as _,x as v,y}from"./CardContainerLogic-BRPeO_mi.js";import{a as b,o as x}from"./ShareThisPage-DVtrJarQ.js";import{n as S,t as C}from"./GenericCardIcon-CrlX9fZg.js";import{n as w,t as T}from"./GenericCard-DZE3Tb9x.js";function E(e){let t=(0,k.useRef)(null);return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(_,{...e,downloadConfirmationContainer:t}),(0,A.jsx)(`div`,{ref:t})]})}function D(e){let{example:t,actionButtonStyle:n=`chip`}=e,r=(0,k.useRef)(null);return(0,A.jsxs)(b.Provider,{value:n,children:[(0,A.jsx)(T,{type:m,title:t.title,description:t.description,icon:(0,A.jsx)(C,{type:m,useTypeForIcon:!0}),cardTopButtons:(0,A.jsx)(_,{entityId:j,name:t.title,hosting:t.hosting,repository:t.repository,externalUrl:t.externalUrl,downloadConfirmationContainer:r}),labels:[{columnDisplayName:`Disease Focus`,value:`Neurofibromatosis type 1`},{columnDisplayName:`Assay`,value:`RNA-seq`},{columnDisplayName:`Files`,value:`128`}]}),(0,A.jsx)(`div`,{ref:r})]})}function O(e,t=`chip`){return(0,A.jsx)(D,{example:e,actionButtonStyle:t})}var k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J;e((()=>{d(),k=t(n(),1),w(),S(),x(),p(),v(),h(),A=i(),j=`syn123`,M=`Example NF dataset`,N={synapse:{hosting:`synapse`,title:`NF1 Patient-Derived Cell Line Atlas`,description:`Whole-genome and RNA sequencing of patient-derived NF1 cell lines, stored in Synapse-managed storage and downloadable through any Synapse client.`},externalCloud:{hosting:`external-cloud`,title:`Plexiform Neurofibroma Imaging Collection`,description:`High-resolution MRI volumes hosted in a collaborator-owned cloud bucket. Files download exactly like Synapse-hosted data, but live outside Sage-managed storage.`},externalDownload:{hosting:`external-download`,repository:`GEO`,externalUrl:`https://www.ncbi.nlm.nih.gov/geo/`,title:`Schwann Cell Transcriptome Series`,description:`Expression series indexed in Synapse but downloaded directly from GEO. Fully downloadable through Synapse clients, though transfer speed depends on the external server.`},externalAccess:{hosting:`external-access`,repository:`dbGaP`,externalUrl:`https://www.ncbi.nlm.nih.gov/gap/`,title:`NF1 Germline Variation Study (Controlled Access)`,description:`Records describing controlled-access whole-genome data held in dbGaP. The data cannot be downloaded through Synapse and must be requested through the external access process.`},mixed:{hosting:`mixed`,repository:`dbGaP`,title:`Multi-Omics NF1 Cohort (Open + Controlled)`,description:`Processed expression and imaging files are downloadable from Synapse, while the raw germline sequencing for the same samples is controlled-access in dbGaP. Download retrieves the Synapse-available files; the rest is requested separately.`},unavailable:{hosting:`unavailable`,title:`NF Registry Cohort (Record Only)`,description:`A discovery record describing a cohort whose data is not available for download through Synapse, with no external repository to link to. No download or access action is offered.`}},P={title:`Explore/DatasetHosting`,component:_,args:{isAuthenticated:!0},parameters:{layout:`padded`}},F=[{field:`hosting`,kind:`Controlled (6 values)`,affectsBehavior:`Yes — the only field that does`,example:`external-download`},{field:`repository`,kind:`Free text`,affectsBehavior:`No — display label only`,example:`GEO, Zenodo, Smith Lab Server…`},{field:`externalUrl`,kind:`Free text`,affectsBehavior:`No — link target for external-access`,example:`https://www.ncbi.nlm.nih.gov/gap/`}],I={render:()=>(0,A.jsxs)(s,{gap:3,sx:{maxWidth:820},children:[(0,A.jsxs)(o,{children:[(0,A.jsx)(r,{variant:`headline3`,sx:{mb:1},children:`Dataset hosting — data model`}),(0,A.jsx)(r,{variant:`body1`,sx:{color:`text.secondary`},children:`One button per dataset communicates how it is hosted and performs the right action. It is driven by three annotation values:`})]}),(0,A.jsxs)(c,{size:`small`,children:[(0,A.jsx)(l,{children:(0,A.jsxs)(u,{children:[(0,A.jsx)(f,{children:(0,A.jsx)(`strong`,{children:`Annotation`})}),(0,A.jsx)(f,{children:(0,A.jsx)(`strong`,{children:`Kind`})}),(0,A.jsx)(f,{children:(0,A.jsx)(`strong`,{children:`Drives behavior?`})}),(0,A.jsx)(f,{children:(0,A.jsx)(`strong`,{children:`Example`})})]})}),(0,A.jsx)(a,{children:F.map(e=>(0,A.jsxs)(u,{children:[(0,A.jsx)(f,{children:(0,A.jsx)(`code`,{children:e.field})}),(0,A.jsx)(f,{children:e.kind}),(0,A.jsx)(f,{children:e.affectsBehavior}),(0,A.jsx)(f,{children:e.example})]},e.field))})]}),(0,A.jsxs)(o,{children:[(0,A.jsx)(r,{variant:`body1`,sx:{display:`block`,mb:1,fontWeight:700},children:`The six hosting values`}),(0,A.jsxs)(c,{size:`small`,children:[(0,A.jsx)(l,{children:(0,A.jsxs)(u,{children:[(0,A.jsx)(f,{children:(0,A.jsx)(`strong`,{children:`hosting`})}),(0,A.jsx)(f,{children:(0,A.jsx)(`strong`,{children:`Downloadable?`})}),(0,A.jsx)(f,{children:(0,A.jsx)(`strong`,{children:`Button style`})}),(0,A.jsx)(f,{children:(0,A.jsx)(`strong`,{children:`Chip style`})})]})}),(0,A.jsx)(a,{children:Object.keys(y).map(e=>{let t=y[e],n=t.label.includes(`{repository}`)?e===`external-access`?`dbGaP`:`GEO`:void 0,r=t=>(0,A.jsx)(b.Provider,{value:t,children:(0,A.jsx)(E,{entityId:j,name:M,hosting:e,repository:n,externalUrl:`https://example.org/`})});return(0,A.jsxs)(u,{children:[(0,A.jsx)(f,{children:(0,A.jsx)(`code`,{children:e})}),(0,A.jsx)(f,{children:t.downloadable?`Yes`:`No`}),(0,A.jsx)(f,{children:r(`button`)}),(0,A.jsx)(f,{children:r(`chip`)})]},e)})})]})]})]})},L={name:`All Flavors - Chip Style`,render:()=>(0,A.jsx)(s,{gap:4,sx:{maxWidth:900},children:Object.values(N).map(e=>{let t=y[e.hosting];return(0,A.jsxs)(o,{children:[(0,A.jsxs)(s,{direction:`row`,gap:1,alignItems:`baseline`,sx:{mb:1},children:[(0,A.jsx)(r,{variant:`overline`,sx:{fontWeight:700},children:e.hosting}),(0,A.jsxs)(r,{variant:`body2`,sx:{color:`text.secondary`},children:[t.downloadable?`Downloadable through Synapse`:`Not downloadable — access handled externally`,t.tooltip?` · ${g(t.tooltip,e.repository)}`:``]})]}),O(e)]},e.hosting)})})},R={name:`All Flavors - Button Style`,render:()=>(0,A.jsx)(s,{gap:4,sx:{maxWidth:900},children:Object.values(N).map(e=>(0,A.jsxs)(o,{children:[(0,A.jsx)(r,{variant:`overline`,sx:{fontWeight:700},children:e.hosting}),O(e,`button`)]},e.hosting))})},z={args:{isAuthenticated:!1},render:()=>(0,A.jsx)(s,{gap:4,sx:{maxWidth:900},children:[N.synapse,N.externalAccess,N.unavailable].map(e=>(0,A.jsxs)(o,{children:[(0,A.jsx)(r,{variant:`overline`,sx:{fontWeight:700},children:e.hosting}),O(e)]},e.hosting))})},B={render:()=>O(N.synapse)},V={render:()=>O({hosting:``,title:`Legacy NF Dataset (no hosting annotation)`,description:`This row has no hosting value. The card treats it as Synapse-hosted: the standard Download control.`})},H={render:()=>O(N.externalCloud)},U={render:()=>O(N.externalDownload)},W={render:()=>O(N.externalAccess)},G={render:()=>O(N.mixed)},K={render:()=>O(N.unavailable)},q={render:()=>(0,A.jsxs)(s,{gap:3,sx:{maxWidth:720},children:[(0,A.jsxs)(o,{children:[(0,A.jsx)(r,{variant:`body1`,sx:{fontWeight:700,mb:1},children:`external-download — any repository, still a download`}),(0,A.jsx)(s,{direction:`row`,gap:2,flexWrap:`wrap`,alignItems:`center`,children:[`GEO`,`ENA`,`Zenodo`,`figshare`,`Smith Lab Server`].map(e=>(0,A.jsx)(E,{entityId:j,name:M,hosting:`external-download`,repository:e},e))})]}),(0,A.jsxs)(o,{children:[(0,A.jsx)(r,{variant:`body1`,sx:{fontWeight:700,mb:1},children:`external-access — any repository, still an external link`}),(0,A.jsx)(s,{direction:`row`,gap:2,flexWrap:`wrap`,alignItems:`center`,children:[`dbGaP`,`EGA`,`JGA`,`Some Other Archive`].map(e=>(0,A.jsx)(E,{name:M,hosting:`external-access`,repository:e,externalUrl:`https://example.org/`},e))})]}),(0,A.jsxs)(o,{children:[(0,A.jsx)(r,{variant:`body1`,sx:{fontWeight:700,mb:1},children:`No repository provided — graceful generic label`}),(0,A.jsxs)(s,{direction:`row`,gap:2,flexWrap:`wrap`,alignItems:`center`,children:[(0,A.jsx)(E,{entityId:j,name:M,hosting:`external-download`}),(0,A.jsx)(E,{name:M,hosting:`external-access`,externalUrl:`https://example.org/`})]})]})]})},I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
