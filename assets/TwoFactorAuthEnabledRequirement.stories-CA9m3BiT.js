import{n as o,b as n,H as c}from"./iframe-CV5uF1_e.js";import{T as m}from"./TwoFactorAuthEnabledRequirement-Cj6_Zr9t.js";import"./index-Chi_LkuB.js";import"./RequirementItem-DKL3jPdB.js";import"./LockTwoTone-Cor2eGev.js";const w={title:"Governance/Data Access Request Flow/Requirements/TwoFactorAuthEnabledRequirement",component:m,parameters:{stack:"mock"},argTypes:{isAuthenticated:{control:{type:"boolean"}}},args:{isAuthenticated:!0}};function a(r){return[o.get(`${n}/auth/v1/2fa`,()=>{const s={status:r?"ENABLED":"DISABLED"};return c.json(s,{status:200})})]}const e={parameters:{msw:{handlers:[a(!0)]}}},t={parameters:{msw:{handlers:[a(!1)]}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  parameters: {
    msw: {
