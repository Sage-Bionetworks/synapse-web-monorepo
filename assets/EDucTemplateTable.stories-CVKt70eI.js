import{o as e}from"./preload-helper-CsHsquCd.js";import{_ as t,i as n,t as r}from"./core-CI8DLeHF.js";import{Fn as i,Ht as a,Nn as o,Ut as s,zn as c}from"./synapse-client-CbDZIRzY.js";import{J as l,Y as u}from"./iframe-C8QBgvqW.js";import{n as d,t as f}from"./EDucTemplateTable-BxJ7D923.js";var p,m,h,g,_;e((()=>{u(),c(),o(),r(),d(),p={title:`Governance/eDUC Templates Table`,component:f,parameters:{stack:`mock`,msw:{handlers:l(i)}}},m={name:`Templates table`},h={name:`Templates table — invalid validation result`,parameters:{msw:{handlers:[n.get(`${i}${s(`:templateId`)}`,()=>t.json({isValid:!1,reason:`Template is missing required signer tab.`},{status:200})),...l(i)]}}},g={name:`Templates table — empty`,parameters:{msw:{handlers:[n.post(`${i}${a}`,()=>t.json({results:[]},{status:200}))]}}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
