import{n as e}from"./chunk-jRWAZmH_.js";import{Ao as t,GS as n,Io as r,Ro as i}from"./iframe-RNzK9wcX.js";import{n as a,t as o}from"./RouteErrorBoundary-By278a3P.js";function s(e,t){return i([{path:`/`,element:(0,c.jsx)(`div`,{children:`This should not render`}),errorElement:(0,c.jsx)(o,{icon:t}),loader:()=>{throw e}}])}var c,l,u,d,f,p,m,h,g,_,v;e((()=>{t(),a(),c=n(),l={title:`Components/Error/RouteErrorBoundary`,component:o,parameters:{layout:`fullscreen`}},u={render:()=>(0,c.jsx)(r,{router:s(Error(`Something went wrong while loading the page`))})},d={render:()=>{let e=Error(`Failed to fetch data from the server`);return e.stack=`Error: Failed to fetch data from the server
