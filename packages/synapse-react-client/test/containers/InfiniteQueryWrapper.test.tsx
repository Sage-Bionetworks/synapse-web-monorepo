...
} from '../../src/components/InfiniteQueryWrapper'
import {
  LockedColumn,
  QueryContextType,
  useQueryContext,
...
// utility function
async function renderComponent(props: Partial<InfiniteQueryWrapperProps>) {
  await act(() => {
    render(
...
jest
  ...
  .mockImplementation(queryBundleRequest => {
