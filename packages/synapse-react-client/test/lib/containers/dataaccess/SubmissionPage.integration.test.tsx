...
import * as RejectDataAccessRequestModalModule from '../../../../src/lib/containers/dataaccess/RejectDataAccessRequestModal'
...
jest.mock('../../../../src/lib/containers/widgets/FileHandleLink', () => ({
  FileHandleLink: ({
    fileHandleAssociation,
  }: {
...
jest.mock('../../../../src/lib/containers/markdown/MarkdownSynapse', () => ({
  __esModule: true,
