...
import * as MarkdownSynapseImageModule from '../../../../src/lib/containers/markdown/widget/MarkdownSynapseImage'
import * as MarkdownPlotModule from '../../../../src/lib/containers/markdown/widget/MarkdownSynapsePlot'
...
jest.mock('../../../../src/lib/containers/widgets/SynapsePlot', () => {
  return {
    __esModule: true,
...
jest.mock('../../../../src/lib/containers/widgets/SynapseImage', () => {
  return {
    __esModule: true,
...
jest.mock('../../../../src/lib/containers/provenance/ProvenanceGraph', () => {
  return {
    __esModule: true,
