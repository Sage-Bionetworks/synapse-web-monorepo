...
import { EvaluationEditor as mockEvaluationEditor } from '../../../../src/lib/containers/evaluation_queues/EvaluationEditor'
import {
...
jest.mock(
  '../../../../src/lib/containers/evaluation_queues/EvaluationEditor',
  () => ({
