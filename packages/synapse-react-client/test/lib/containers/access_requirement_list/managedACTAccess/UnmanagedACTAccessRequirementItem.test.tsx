...
} from '../../../../../src/lib/containers/access_requirement_list/UnmanagedACTAccessRequirementItem'
...
async function testInstructionsToggle() {
  expect(
    screen.queryByText(mockACTAccessRequirement.actContactInfo),
  ).not.toBeInTheDocument()

  let toggle = await screen.findByRole('button', { name: 'View Instructions' })
  await userEvent.click(toggle)

  await screen.findByText(mockACTAccessRequirement.actContactInfo)
