...
import {
  StepperDialog,
  StepperDialogProps,
} from '../src/components/StepperDialog'
import Button from '@mui/material/Button'
import { Step } from '../src/components/StepperDialog/StepperDialog'
...
const Wrapper = args => {
  const [step, setStep] = useState<Step>(steps.STEP_1)
  const [content, setContent] = useState<JSX.Element>(steps.STEP_1.content)
...
const meta = {
  ...
  render: (args: StepperDialogProps) => <Wrapper {...args} />,
