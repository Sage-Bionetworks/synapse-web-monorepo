...
export type FieldDefinitionDrawerProps = {
   ...
   * changing it moves the property's definition between the schema's top-level `properties` and
   * the matching `allOf` branch, so ACT never has to hand-edit `allOf` for the common case.
   */
