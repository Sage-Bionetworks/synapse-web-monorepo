...
const GRAY_COLOR_PALETTE: Partial<Color> = {
  1000: '#22252a',
  900: '#353a3f',
  800: '#4a5056',
  700: '#878e95',
...
export function getPalette(mode: PaletteMode): PaletteOptions {
  const primaryPalette = generatePalette('#395979', {
    100: '#d7dee4',
    200: '#b0bdc9',
    300: '#889baf',
    400: '#617a94',
  ...
  return {
    ...
    grey: GRAY_COLOR_PALETTE,
    // The neutral palette can be used to color components like buttons in grayscale
    neutral: generatePalette(GRAY_COLOR_PALETTE[700]!),
    darkPrimary: generatePalette('#164B6E'),
    lightPrimary: { ...generatePalette('#f8f9fa'), contrastText: '#164B6E' },
    light: {
      ...generatePalette('#f8f9fa'),
      contrastText: GRAY_COLOR_PALETTE[1000],
    },
    success: { main: '#32a330', contrastText: '#fff' },
    info: { main: '#017fa5' },
    warning: { main: '#cc9f00' },
    error: { main: '#c13415' },
    background: {
      default: mode === 'light' ? 'white' : primaryPalette[800]!,
      paper: mode === 'light' ? 'white' : primaryPalette[700]!,
    },
    text:
      mode === 'light'
        ? {
            primary: GRAY_COLOR_PALETTE[900], // gray-900
            secondary: GRAY_COLOR_PALETTE[800], // gray-800
          }
        : {
            primary: GRAY_COLOR_PALETTE[200],
            secondary: GRAY_COLOR_PALETTE[400],
          },
...
export const geniePalette: PaletteOptions = {
  ...palette,
  primary: generatePalette('#26881F'),
  secondary: generatePalette('#26881F'),
}
