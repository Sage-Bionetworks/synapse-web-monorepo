...
// so the DUO genetic-studies term uses Google's Material Symbols "genetics" icon,
// inlined as an MUI SvgIcon so it inherits sizing and color like the rest.
// (Material Symbols, Apache-2.0.)
export default function GeneticsIcon(props: SvgIconProps) {
  return (
