...
import { RequirementItemState } from '../AccessApprovalCheckMark'
...
export default function ManagedACTAccessRequirementItem(
  ...
  let requirementItemState: RequirementItemState = RequirementItemState.LOADING
  if (!isLoading) {
    switch (accessRequirementStatus?.currentSubmissionStatus?.state) {
      case SubmissionState.APPROVED:
        requirementItemState = RequirementItemState.COMPLETE
        break
      case SubmissionState.SUBMITTED:
        requirementItemState = RequirementItemState.PENDING
        break
      case SubmissionState.REJECTED:
      case SubmissionState.CANCELLED:
      default:
        requirementItemState = RequirementItemState.LOCKED
    }
  }
