...
import RequestDataAccessStep1 from './ManagedACTAccessRequirementRequestFlow/RequestDataAccessStep1'
import RequestDataAccessStep2 from './ManagedACTAccessRequirementRequestFlow/RequestDataAccessStep2'
import RequestDataAccessSuccessV2 from './ManagedACTAccessRequirementRequestFlow/RequestDataAccessSuccessV2'
import {
  Box,
  Dialog,
  DialogContent,
 ...
 */
export default function AccessRequirementListV2(
  ...
  if (renderAsModal) {
    switch (requestDataStep) {
      ...
      case RequestDataStep.COMPLETE:
        renderContent = <RequestDataAccessSuccessV2 onHide={onHide} />
        break
