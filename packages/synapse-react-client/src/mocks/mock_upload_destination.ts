...
export const mockSynapseStorageUploadDestination = {
...
export const mockS3UploadDestination = {
  ...mockSynapseStorageUploadDestination,
  baseKey: 'exampleS3BaseKey',
  stsEnabled: true,
  concreteType: 'org.sagebionetworks.repo.model.file.S3UploadDestination',
} satisfies S3UploadDestination

export const mockExternalS3UploadDestination = {
...
} satisfies ExternalS3UploadDestination

export const mockExternalGoogleCloudUploadDestination = {
  ...mockSynapseStorageUploadDestination,
...
} satisfies ExternalGoogleCloudUploadDestination

export const mockExternalUploadDestination = {
  ...mockSynapseStorageUploadDestination,
...
} satisfies ExternalUploadDestination

export const mockExternalObjectStoreUploadDestination = {
  ...mockSynapseStorageUploadDestination,
...
} satisfies ExternalObjectStoreUploadDestination
