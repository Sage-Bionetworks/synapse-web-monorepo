...
const syn16787123 = {
  ...
  queryResult: {
    ...
    queryResults: {
      ...
      tableId: 'syn16787123',
      etag: '58a859ba-e4b2-41bf-8354-4b8a6da0a4fd',
      headers: [
        {
          name: 'studyName',
          columnType: 'LARGETEXT',
      ...
      rows: [
        ...
        },
        {
          ...
          values: [
            ...
            'Accessing data from this project requires submission of an Intended Data Use Statement and agreement to Data Access Terms of Use.  To access data from this project, please follow these steps: <br> 1: Register for a Synapse account here (if you do not already have one). <br> 2: Navigate to the [data files page](https://www.synapse.org/#!Synapse:syn10145839). <br> 3: Click on "Request Access" next to the "lock" symbol. <br> 4: Follow the instructions on that page. You will be prompted to "Request access to Data" by clicking the Request Access button and submitting an Intended Data Use statement (1-3 paragraphs in English) to be posted publicly. You will also need to review the Terms of Use and click “Accept Terms of Use". If you have questions about the data access process please email nf-osi@sagebionetworks.org.',
            'In using this data, you promise to acknowledge the data contributors by including the following statement: “The research team would like to thank the Children\'s Tumor Foundation Synodos Low Grade Glioma team that collected and shared the data used in this study.” Please include the following citation for these data: “Fisher, M.J., Jones, D.T.W., Li, Y. et al. Integrated molecular and clinical analysis of low-grade gliomas in children with neurofibromatosis type 1 (NF1). Acta Neuropathol (2021). https://doi.org/10.1007/s00401-021-02276-5" In addition, please acknowledge the NF Data Portal like so: “The results published here are in whole or in part based on data obtained from the NF Data Portal (http://www.nf.synapse.org, RRID:SCR_021683) and made available through the NF Open Science Initiative.',
            'syn5698493',
          ],
        },

        {
          ...
          values: [
            ...
            'syn6633069',
            'This study aims to obtain the genomic landscape of glioma associated with NF1 syndrome. While the clinical aspects of NF1 are well characterized and the pathogenesis of plexiform neurofibromas has been widely studied, surprisingly little is known about the genetic and epigenetic changes in the NF1 mutant glioma. This has hindered the development of effective therapies for NF1-mutant cancers. To address this challenge and uncover the driver genes in NF1-glioma, The team will analyze whole-exome and transcriptome data from glioma samples of pediatric and adult NF1 patients. Alterations in the genetic networks will be contextualized in the natural genetic and cellular environment of a specific tumor, and the key driving modules on which specific NF1-glioma subgroups rely for growth, survival and progression will be identified. With this information in hand, we can target the critical alterations with specific drugs, often already available for other types of diseases. The specific aims are to (1) comprehensively characterize the genomic and epigenetic landscape of NF1 gliomas from patients of all age groups, (2) identify driver genetic alterations in NF1-gliomas from the integration of somatic copy number variations, mutations and gene fusions (translocations), (3) reconstruct a somatic alteration network for the inference of mutual exclusivity and co-occurrence of genetic aberrations in NF1-gliomas and (4) validate the functional significance of the inferred alterations in neural systems in vitro and in vivo, and target therapeutically key genetic nodes with highly specific inhibitors.',
            'Accessing the data from this study requires a Synapse account.',
        ...
        },
        {
          ...
          values: [
            ...
            'syn7239560',
            'A drug-target database was built by Evotec using publicly available data in order to define targets of the Minnesota Synodos NF1 screening molecules. A similar resource can be found in the Drug-Target Explorer project conducted by Sage Bionetworks.',
            'Accessing the data from this study requires a Synapse account.',
            'The data from this study are still under embargo, therefore, if you have been granted access by the data contributor, you must work with them to determine how to acknowledge your collaboration in any manuscripts that arise. In addition, please acknowledge the NF Data Portal like so: “The results published here are in whole or in part based on data obtained from the NF Data Portal (http://www.nf.synapse.org, RRID:SCR_021683) and made available through the NF Open Science Initiative.”',
            'syn7239560',
          ],
        },
        {
          ...
          values: [
            ...
            'syn7217935',
            'A cardinal feature of NF1 is the development of dermal (DN) and plexiform neurofibromas (PN), benign tumors that form in the dermis or along a nerve plexus, respectively. While these tumors are histologically similar - both are complex tumors containing a number of cell types including proliferating Schwann lineage cells (from which the tumors arise), fibroblasts, and infiltrating mast cells - they arise in different locations of the body and at different developmental time points. Although initially benign, PN can undergo malignant transformation and develop into MPNSTs. The only treatment for PN is surgery, however complete resection is often difficult due to nerve involvement. The goal of this project is to generate a physiologically relevant PN cellular model system for use in preclinical drug screening.',
            'N/A',
            'N/A',
            'syn7217935',
          ],
        ...
        },
        {
          ...
          values: [
            ...
            'syn7239479',
            'There is a need for effective therapies for neurofibromas, particularly the larger, plexiform neurofibromas. Tissue culture is an important tool for research. However, it is difficult to derive enriched human Schwann cell cultures, and most enter replicative senescence after 6-10 passages, impeding cell-based research in NF1. We are well-positioned to develop cellular models, and collaborate with a robotics R&D/Lead Optimization group. THe goals of this project is to identify (create/characterize) semi-immortalized pNF and normal/heterozygous SC lines with suitable phenotypes, such that these lines can be tested in and transitioned to an HTS environment.',
            null,
            null,
            'syn7239479',
          ],
        ...
        },
        {
          ...
          values: [
            ...
            'syn8016577',
            'Mechanical cues, including tissue geometry and intracellular forces, have been shown to regulate the neoplastic transformation process up to malignancy. The hypothesis of this project is that the neoplastic phenotype of Schwann cells (SCs) is fostered by the amplification of integrated signaling pathways triggered not only by loss of neurofibromin and by the ensuing Ras hyperactivation, but also by deregulation in the composition and physical properties of the extracellular matrix (ECM). The goal of this project is to determine the role of the Extracellular Matrix (ECM) in the neoplastic transformation of Schwann cells (SCs).',
            null,
            'The data from this study are still under embargo, therefore, if you have been granted access by the data contributor, you must work with them to determine how to acknowledge your collaboration in any manuscripts that arise. In addition, please acknowledge the NF Data Portal like so: “The results published here are in whole or in part based on data obtained from the NF Data Portal (http://www.nf.synapse.org, RRID:SCR_021683) and made available through the NF Open Science Initiative.”',
            'syn8016577',
          ],
        ...
        },
        {
          ...
          values: [
            ...
            'syn4939910',
            'Cutaneous neurofibromas (CNFs) can be distinguished from other cutaneous manifestations of NF1 based on their size (0.5-3cm), sessile or polypoid morphology, and typical lack of pigment. CNFs account for substantial morbidity and disfigurement in NF1. Unlike plexiform neurofibromas, which are congenital lesions, CNFs manifest during adolescence suggesting that their pathogenesis is influenced by environmental or hormonal factors. CNFs are comprised of a confederacy of cell types with distinct embryonic lineages, including Schwann-like cells, perineural cells (neural crest or neuro-ectoderm), fibroblasts (mesoderm), and mast cells (bone marrow-derived). The goal of this project is to develop new therapy strategies for peripheral nerve sheath tumors associated with Neurofibromatosis Type 1: Cutaneous Neurofibromas (CNFs) and Malignant Peripheral Nerve Sheath Tumors (MPNSTs).',
            'Accessing data from this project requires agreement to Data Access Terms of Use. <br><br> To access data from this project, please follow these steps: <br><br> **1**: Register for a Synapse account [here](https://www.synapse.org/#!RegisterAccount:0) (if you do not already have one). <br> **2**: Navigate to the <a href="https://www.synapse.org/#!Synapse:syn11642240" target="_blank">data files page</a>. <br> **3**: Click on "Request Access" next to the "lock" symbol. <br> **4**: Follow the instructions on that page. You will be prompted be prompted to review the Terms of Use and click "Accept Terms of Use". If you have questions about the data access process please email nf-osi@sagebionetworks.org. <br>',
            'Please cite the study investigators on all publications or presentations resulting from the use of these data as follows: Grit, J.L., Johnson, B.K., Dischinger, P.S. et al. Distinctive epigenomic alterations in NF1-deficient cutaneous and plexiform neurofibromas drive differential MKK/p38 signaling. Epigenetics & Chromatin 14, 7 (2021). https://doi.org/10.1186/s13072-020-00380-6." . In addition, please acknowledge the NF Data Portal like so: “The results published here are in whole or in part based on data obtained from the NF Data Portal (http://www.nf.synapse.org, RRID:SCR_021683) and made available through the NF Open Science Initiative.”',
            'syn4939910',
          ],
        },
        {
        ...
        },
        {
          ...
          versionNumber: 897,
          values: [
            'The Development and Validation of PRO Measures to Assess Pain in Individuals with NF1 and pNF',
            'syn4939912',
            'Clinical trials for the treatment of PNs in children and adults with NF1 are underway. The FDA recommends including endpoints in NF1 clinical trials that assess changes in symptoms, such as pain, in addition to tumor reduction. Currently, no valid PRO measures exist that assess PN-related pain and its effect on daily functioning. The first phase of this limited-site study is to modify existing PRO pain tools using qualitative methods to ensure understanding of the concepts being assessed and to examine how the current tools work in the NF1/PN population. The second phase is to examine the psychometric properties of the modified PROs in individuals with NF1 and PNs. The goal of this project is to produce the most reliable, valid, and feasible measures of pain intensity and pain interference, as end-points in clinical trials or intervention studies.',
            null,
            'The data from this study are still under embargo, therefore, if you have been granted access by the data contributor, you must work with them to determine how to acknowledge your collaboration in any manuscripts that arise. In addition, please acknowledge the NF Data Portal like so: “The results published here are in whole or in part based on data obtained from the NF Data Portal (http://www.nf.synapse.org, RRID:SCR_021683) and made available through the NF Open Science Initiative.”',
            'syn4939912',
          ],
  ...
  lastUpdatedOn: '2024-08-17T17:19:44.287Z',
