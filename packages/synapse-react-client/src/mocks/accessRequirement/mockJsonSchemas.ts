 ...
 * (`irbApprovalNumber`), gated behind an `x-synapse-submissionContext` conditional per PLFM-9449
 * (design v34): the server no longer resolves per-field submission context, so the client
 * expresses it directly in the schema instead.
 */
