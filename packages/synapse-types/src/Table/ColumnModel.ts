...
export type ColumnModel = {
  ...
  maximumSize?: number // A parameter for columnTypes with a maximum size. For example, ColumnTypeEnum.strings have a default maximum size of 50 characters, but can be set to a maximumSize of 1 to 1000 characters.
