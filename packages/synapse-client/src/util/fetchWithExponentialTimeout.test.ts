...
describe('fetchWithExponentialTimeout', () => {
  ...
  it('should handle successful responses without retries', async () => {
    ...
    const responseBody = await fetchWithExponentialTimeout('/test-url', {
      method: 'GET',
    })
  ...
  it('should retry many times on 429 status code', async () => {
    ...
    const responsePromise = fetchWithExponentialTimeout('/test-url', {
      method: 'GET',
    })
  ...
  it.each([502, 503])(
    ...
    async code => {
      ...
      const promise = fetchWithExponentialTimeout('/test-url', {
        method: 'GET',
      })
  ...
  it('should throw on network errors', async () => {
    ...
    await expect(() =>
      fetchWithExponentialTimeout('/test-url', {
        method: 'GET',
      }),
    ).rejects.toEqual(
