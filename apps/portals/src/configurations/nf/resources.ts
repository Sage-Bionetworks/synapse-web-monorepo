...
export const observationsSql =
  'SELECT observationSubmitterName as "submitterName", synapseId as "submitterUserId", observationTime as "time", observationTimeUnits as "timeUnits", observationText as "text", observationType as "tag", observationPhase as "phase", species, doi FROM syn51735464'
