...
function HomePageInternal() {
  ...
  const description = (
    <span style={{ color: theme.palette.grey[200] }}>
      The NIA Division of Geriatrics and Clinical Gerontology supports multiple
      research programs composed of interdisciplinary communities of scientists
      who aim to integrate approaches, data, tools, and resources to address
      critical questions in translational aging and longevity research.
      <br /> <br /> Discover and download multi-omic datasets, publications,
      computational tools, and other resources generated by these programs.
    </span>
  )
  return (
    <>
