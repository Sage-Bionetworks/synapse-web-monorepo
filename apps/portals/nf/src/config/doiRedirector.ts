...
export type NFResourceType = 'STUDY'
...
export const RESOURCE_TYPE_KEY_CONFIGURATION = {
  STUDY: ['studyId'],
} as const satisfies Record<NFResourceType, string[]>

export const doiSerializer = new PortalsDoiIdSerializer<NFResourceType>({
 ...
 */
export const doiRedirector: PortalResourceRedirector<NFResourceType> = (
  resourceType: NFResourceType,
  ...
  switch (resourceType) {
    case 'STUDY':
      return `/Explore/Studies/${resourceAttributes.studyId}`
    default:
      throw new Error(
