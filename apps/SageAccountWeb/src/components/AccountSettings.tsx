    ...
    <div className="item-completion">
      {isComplete ? (
        <span className="completeIcon">
          <SynapseComponents.IconSvg icon="check" /> Completed
        </span>
      ) : (
        <span className="incompleteIcon">
          <SynapseComponents.IconSvg icon="close" /> Incomplete
        </span>
      )}
    </div>
  )
          ...
          <Box sx={{ display: 'flex', my: '60px' }}>
            ...
            <div>
              ...
              <Paper
                ...
                className="account-setting-panel main-panel"
              >
                <SynapseComponents.TwoFactorAuthSettingsPanel
