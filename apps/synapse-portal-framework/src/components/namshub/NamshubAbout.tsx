      ...
      <Stack className={styles.aboutTextContainer}>
        ...
        <span className={styles.aboutDescription}>
          <Typography variant="body1">
            Researchers developing new drugs or studying human diseases often
            rely on animal models that don't accurately reflect human biology. A
            ...
            (NAMs), as more reliable tools for modeling human health and
            disease.
          </Typography>
          <br />
          <Typography variant="body1">
            The NAM Hub will enable the standardization, harmonization, and
            sharing of datasets - from molecular tests to 3D cultures to
            simulated population outcomes. The hub will serve as the
            consortium’s backbone for data, metadata, code, and computational
            models; provide AI-augmented data curation and a framework for
            harmonizing NAMs data across the consortium; and be a source of
            analytical tools to help researchers work with datasets.
          </Typography>
